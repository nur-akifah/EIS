                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <br>
                                    <h5 class="m-0 font-weight-bold text-primary">Machine FOR Data</h5><br>
                                </div>
                                            ...
                                            <div class="row justify-content-center ">
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-2 mt-2 mt-md-0">
                                                    <select class="form-control" id="cell" name="cell" onchange="updateButtonName()" required>
                                                        ...
                                                        <option value="for_ra100">RA100</option>
                                                        <option value="for_ra101">RA101</option>
                                                        <option value="for_ra102">RA102</option>
                                                        <option value="for_ra103">RA103</option>
                                                        <option value="for_ra104">RA104</option>
                                                        <option value="for_ra105">RA105</option>
                                                        <option value="for_ra106">RA106</option>
                                                        <option value="for_ra108">RA108</option>
                                                        <option value="for_gl6">GL6</option>
                                                    </select>
                                                </div>
                            ...
                            <!-- === Table dan Chart === -->
                            <?php include 'Graphics/gl6-for-graphic.php' ?>
                            <div class="table-responsive">
                                <?php include 'Includes/gl6-for-filtertable.php' ?>
                            </div>
                        </div>
