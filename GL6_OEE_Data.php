...
<body id=" page-top">
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <br>
                                    <h5 class="m-0 font-weight-bold text-primary">Machine OEE Data</h5><br>
                                </div>
                                        ...
                                        <div class="container">
                                            <div class="row justify-content-center ">
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-2 mt-2 mt-md-0">
                                                    <input name="datetimepicker" type="datetime-local" id="datetimepicker" class="form-control" onclick="toggleButtons('datetimepicker')" placeholder="yyyy-mm-ddTHH:mm" aria-label="From" required>
                                                </div>
                                                <div class="col-sm-12 col-md-4 col-lg-2 mt-2 mt-md-0">
                                                    <input name="endDatetimePicker" type="datetime-local" id="endDatetimePicker" class="form-control" onclick="toggleButtons('endDatetimepicker')" placeholder="yyyy-mm-ddTHH:mm" aria-label="Till" required>
                                                </div>

                                                <div class="col-sm-12 col-md-4 col-lg-2 mt-2 mt-md-0">
                                                    <select class="form-control" id="cell" name="cell" onchange="updateButtonName()" required>
                                                        <option selected>Select Cell</option>
                                                        <option value="line_output">Line Output</option>
                                                        <option value="oee_ra100">RA100</option>
                                                        <option value="oee_ra101">RA101</option>
                                                        <option value="oee_ra102">RA102</option>
                                                        <option value="oee_ra103">RA103</option>
                                                        <option value="oee_ra104">RA104</option>
                                                        <option value="oee_ra105">RA105</option>
                                                        <option value="oee_ra106">RA106</option>
                                                        <option value="oee_ra108">RA108</option>
                                                    </select>
                                                </div>

                                                <div class="col-sm-12 col-md-4 col-lg-2 mt-2 mt-md-0">
                                                    <input type="submit" value="Search" id="submitButton" class="btn btn-primary btn-block mt-2 mt-md-0" name="search">
                                                </div>
                                            </div>
                                        </div>
                                    </center>
                            ...
                            <!-- === Table dan Chart === -->
                            <?php include 'Graphics/gl6-oee-graphic.php' ?>
                            <div class="table-responsive">
                                <?php include 'Includes/gl6-oee-filtertable.php' ?>
                            </div>
                        </div>
    ...
    <script>
        ...
        function toggleButtons(clickedButtonId) {
            ...
            if (currentButton === document.getElementById('buttonDateTime')) {
                ...
                (currentButton === document.getElementById('datetimepicker') || currentButton === document.getElementById('endDatetimePicker')) &&
                document.getElementById('buttonCurrentShift') && document.getElementById('buttonDateTime')
            ) {
                // Deactivate "Current Hour" and "Current Shift" buttons when date-time pickers are clicked
                document.getElementById('buttonCurrentShift').classList.remove('active');
                document.getElementById('buttonDateTime').classList.remove('active');
                saveSelectedValue();
            }
        ...
        function saveSelectedValue() {
            console.log('Setting Manual DateTime')
        }
    </script>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            if (savedStartDatetime && savedEndDatetime && savedSubmitButton) {
            ...
            datetimePicker.addEventListener("change", saveToLocalStorage);
            endDatetimePicker.addEventListener("change", saveToLocalStorage);

            // Add event listener to the form for submission
            searchForm.addEventListener("submit", function(event) {
                // Save to local storage before submitting the form
                saveToLocalStorage();
            });
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function setCurrentShift() {
                ...
                const formattedEndDatetime = formatDatetimeLocal(new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate(), endHour, 0, 0).toISOString().substring(0, 16).replace('T', ' '));
