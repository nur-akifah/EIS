...
(function () {
  ...
  function Ia(a, d, b) {
    "millisecond" === b
      ? a.setMilliseconds(a.getMilliseconds() + 1 * d)
      : "second" === b
      ? a.setSeconds(a.getSeconds() + 1 * d)
      : "minute" === b
      ? a.setMinutes(a.getMinutes() + 1 * d)
      : "hour" === b
      ? a.setHours(a.getHours() + 1 * d)
      : "day" === b
      ? a.setDate(a.getDate() + 1 * d)
      : "week" === b
      ? a.setDate(a.getDate() + 7 * d)
      : "month" === b
      ? a.setMonth(a.getMonth() + 1 * d)
  ...
  function Ua(a) {
    if (!Oa) {
      var d = !1,
        b = !1;
      "undefined" === typeof ea.Chart.creditHref
        ? ((a.creditHref = ""), (a.creditText = "CanvasJS.com"))
        : ((d = a.updateOption("creditText")),
          (b = a.updateOption("creditHref")));
      if (a.creditHref && a.creditText) {
        a._creditLink ||
          ((a._creditLink = document.createElement("a")),
          a._creditLink.setAttribute("class", "canvasjs-chart-credit"),
          a._creditLink.setAttribute(
            "style",
        ...
        if (0 === a.renderCount || d || b)
          a._creditLink.setAttribute("href", a.creditHref),
            (a._creditLink.innerHTML = a.creditText);
        a._creditLink && a.creditHref && a.creditText
          ? (a._creditLink.parentElement ||
              a._canvasJSContainer.appendChild(a._creditLink),
            (a._creditLink.style.top = a.height - 14 + "px"))
          : a._creditLink.parentElement &&
            a._canvasJSContainer.removeChild(a._creditLink);
      }
    }
  }
  function ia(a, d) {
  ...
  function Z(a, d, b) {
    d.getAttribute("state") !== b &&
      (d.setAttribute("state", b),
      d.setAttribute("type", "button"),
      (d.style.position = "relative"),
      (d.style.margin = "0px 0px 0px 0px"),
      (d.style.padding = "3px 4px 0px 4px"),
      (d.style.cssFloat = "left"),
      d.setAttribute("title", a._cultureInfo[b + "Text"]),
      (d.innerHTML =
  ...
  function z(a, d) {
    ...
    if (
      ...
      this._selectedColorSet =
        "undefined" !== typeof ja[this.colorSet]
          ? ja[this.colorSet]
          : ja.colorSet1;
      ...
      this.canvas.getContext &&
        ...
        (this._eventManager = new na(this)),
        ...
        (this.toolTip = new V(this, this.options.toolTip)),
        (this.data = null),
        (this.axisX = []),
        (this.axisX2 = []),
        (this.axisY = []),
  ...
  function wa(a, d) {
    for (var b = [], c, f = 0; f < a.length; f++)
      if (0 == f) b.push(a[0]);
        ...
        c =
          (Math.abs(
            (a[h].x - a[g].x) / (0 === a[h].x - a[l].x ? 0.01 : a[h].x - a[l].x)
          ) *
            (d - 1)) /
            2 +
          1;
        ...
        c = (a[h].y - a[g].y) / c;
        b[b.length] =
          (a[l].x > a[g].x && 0 < k) || (a[l].x < a[g].x && 0 > k)
            ? {
                x: a[l].x + k / 3,
                y: a[l].y + c / 3,
              }
        ...
        c =
          (Math.abs(
            (a[h].x - a[g].x) / (0 === a[l].x - a[g].x ? 0.01 : a[l].x - a[g].x)
          ) *
            (d - 1)) /
            2 +
          1;
  ...
  function oa(a, d) {
    ...
    if (x(this.options.margin) && a.options.subtitles)
      for (var b = a.options.subtitles, c = 0; c < b.length; c++)
        if (
          ((x(b[c].horizontalAlign) && "center" === this.horizontalAlign) ||
            b[c].horizontalAlign === this.horizontalAlign) &&
          ((x(b[c].verticalAlign) && "top" === this.verticalAlign) ||
            b[c].verticalAlign === this.verticalAlign) &&
          !b[c].dockInsidePlotArea === !this.dockInsidePlotArea
        ) {
          this.margin = 0;
          break;
        }
  ...
  function A(a, d, b, c, f) {
    ...
    "axisX" === b
      ? ("left" === c || "bottom" === c
          ? ((this.optionsName = "axisX"),
            x(this.chart.sessionVariables.axisX[f]) &&
              (this.chart.sessionVariables.axisX[f] = {}),
            (this.sessionVariables = this.chart.sessionVariables.axisX[f]))
          : ((this.optionsName = "axisX2"),
            x(this.chart.sessionVariables.axisX2[f]) &&
              (this.chart.sessionVariables.axisX2[f] = {}),
            (this.sessionVariables = this.chart.sessionVariables.axisX2[f])),
        this.options.interval || (this.intervalType = null),
        "theme2" === this.chart.theme &&
          x(this.options.lineThickness) &&
          (this.lineThickness = 2))
      : "left" === c || "top" === c
      ? ((this.optionsName = "axisY"),
        x(this.chart.sessionVariables.axisY[f]) &&
          (this.chart.sessionVariables.axisY[f] = {}),
        (this.sessionVariables = this.chart.sessionVariables.axisY[f]))
      : ((this.optionsName = "axisY2"),
        x(this.chart.sessionVariables.axisY2[f]) &&
          (this.chart.sessionVariables.axisY2[f] = {}),
        (this.sessionVariables = this.chart.sessionVariables.axisY2[f]));
    ...
    this.type = b;
    "axisX" !== b ||
      (d && "undefined" !== typeof d.gridThickness) ||
    ...
    null !== this.startValue &&
      ...
      ((this.value = f.logarithmic
        ...
        : ((this.startValue.getTime
            ...
            (this.endValue.getTime ? this.endValue.getTime() : this.endValue)) /
          2),
      (this.thickness = f.logarithmic
        ? Math.log(this.endValue / this.startValue) / Math.log(f.logarithmBase)
        : Math.max(this.endValue - this.startValue)),
  ...
  var J = {},
        ...
        return (n = k.replace(a, function (a) {
          switch (a) {
            ...
            case "K":
              return q
                ? "UTC"
                : (String(l).match(g) || [""]).pop().replace(h, "");
            case "z":
        ...
        if (((d = l[u]), "." === d && 0 > k)) k = u;
          ...
          if ("%" === d) h *= 100;
            ...
            ("E" !== d[0] && "e" !== d[0]) ||
              ...
              (q = !0);
          0 > k
            ? (n.push(d), "#" === d || "0" === d ? p++ : "," === d && r++)
            : (m.push(d), ("#" !== d && "0" !== d) || e++);
        }
      q &&
        ((d = Math.floor(a)),
        (s = (0 === d ? "" : String(d)).length - p),
        (h /= Math.pow(10, s)));
      0 > k && (k = u);
      h = (a * h).toFixed(e);
      d = h.split(".");
        ...
        if (((d = n.pop()), "#" === d || "0" === d))
          if ((k++, k === p)) {
            ...
            for (; 0 < w.length; )
              (b = w.pop() + b),
                u++,
                0 === u % q && l === r && 0 < w.length && (b = g + b);
            c && (b = "-" + b);
          } else
            0 < h.length
              ? ((b = h.pop() + b), e++, u++)
              : "0" === d && ((b = "0" + b), e++, u++),
              0 === u % q && l === r && 0 < h.length && (b = g + b);
        else
          ("E" !== d[0] && "e" !== d[0]) ||
          "0" !== d[d.length - 1] ||
          !/[eE][+-]*[0]+/.test(d)
            ? "," === d
              ? (l++, (q = u), (u = 0), 0 < h.length && (b = g + b))
              : (b =
                  1 < d.length &&
                  (('"' === d[0] && '"' === d[d.length - 1]) ||
                    ("'" === d[0] && "'" === d[d.length - 1]))
                    ? d.slice(1, d.length - 1) + b
                    : d + b)
            : ((d =
                0 > s
                  ? d.replace("+", "").replace("-", "")
                  : d.replace("-", "")),
              (b += d.replace(/[0]+/, function (a) {
                return N(s, a.length);
              })));
      c = "";
      for (g = !1; 0 < m.length; )
    ...
    za = function (a) {
      ...
      a.offsetX || 0 === a.offsetX
        ? ((d = a.offsetX), (b = a.offsetY))
        : a.layerX || 0 == a.layerX
        ? ((d = a.layerX), (b = a.layerY))
        : ((d = a.pageX - a.target.offsetLeft),
  ...
  (function () {
    ...
    J.str = {
      ...
      fntStr: [
        112, 120, 32, 67, 97, 108, 105, 98, 114, 105, 44, 32, 76, 117, 99, 105,
        100, 97, 32, 71, 114, 97, 110, 100, 101, 44, 32, 76, 117, 99, 105, 100,
        97, 32, 83, 97, 110, 115, 32, 85, 110, 105, 99, 111, 100, 101, 44, 32,
        65, 114, 105, 97, 108, 44, 32, 115, 97, 110, 115, 45, 115, 101, 114,
        105, 102,
      ],
    ...
    delete ea[J.fSDec([67, 104, 97, 114, 116])][
      J.fSDec([99, 114, 101, 100, 105, 116, 72, 114, 101, 102])
    ];
    J.pro = {
      sCH: ea[J.fSDec([67, 104, 97, 114, 116])][
        J.fSDec([99, 114, 101, 100, 105, 116, 72, 114, 101, 102])
      ],
    };
    J.fAWm = function (a) {
  ...
  M.prototype.setOptions = function (a, d) {
    if (ea[this._defaultsKey]) {
      ...
      for (c in b)
        "publicProperties" !== c &&
          b.hasOwnProperty(c) &&
          (this[c] = a && c in a ? a[c] : d && c in d ? d[c] : b[c]);
    }
  };
  M.prototype.get = function (a) {
    ...
    if (
      d.hasOwnProperty(a) ||
      (d.publicProperties && d.publicProperties.hasOwnProperty(a))
    )
      return this[a];
    window.console &&
      window.console.log(
        'Property "' + a + "\" doesn't exist. Please check for typo."
      );
  };
  M.prototype.set = function (a, d, b) {
    ...
    if ("options" === a) this.createUserOptions(d);
      ...
      c.hasOwnProperty(a) ||
      (c.publicProperties &&
        c.publicProperties.hasOwnProperty(a) &&
        "readWrite" === c.publicProperties[a])
    )
      ...
      window.console &&
        (c.publicProperties &&
        c.publicProperties.hasOwnProperty(a) &&
        "readOnly" === c.publicProperties[a]
          ? window.console.log('Property "' + a + '" is read-only.')
          : window.console.log(
              'Property "' + a + "\" doesn't exist. Please check for typo."
            ));
      return;
  ...
  M.prototype.addTo = function (a, d, b, c) {
    ...
    f.hasOwnProperty(a) ||
    (f.publicProperties &&
      f.publicProperties.hasOwnProperty(a) &&
      "readWrite" === f.publicProperties[a])
      ? (this.options._isPlaceholder && this.createUserOptions(),
        "undefined" === typeof this.options[a] && (this.options[a] = []),
        (a = this.options[a]),
        (b = "undefined" === typeof b || null === b ? a.length : b),
        a.splice(b, 0, d),
        c && ((chart = this.chart || this), chart.render()))
      : window.console &&
        (f.publicProperties &&
        f.publicProperties.hasOwnProperty(a) &&
        "readOnly" === f.publicProperties[a]
          ? window.console.log('Property "' + a + '" is read-only.')
          : window.console.log(
              'Property "' + a + "\" doesn't exist. Please check for typo."
            ));
    ...
    if ("undefined" !== typeof a || this.options._isPlaceholder)
      if (
        ...
        (this.options = "undefined" === typeof a ? {} : a),
          ...
          this.optionsName
            ? (d = this.optionsName)
            : (d = this._defaultsKey) && 0 !== d.length
            ? ((b = d.charAt(0).toLowerCase()),
              1 < d.length && (b = b.concat(d.slice(1))),
              (d = b))
            : (d = void 0),
          (a[d] = this.options);
  };
  ...
  M.prototype.updateOption = function (a) {
    var d = ea[this._defaultsKey],
      b = this.options.theme
        ? this.options.theme
        : this.chart && this.chart.options.theme
    ...
    a in d &&
      (f = a in this.options ? this.options[a] : c && a in c ? c[a] : d[a]);
  ...
  M.prototype.dispatchEvent = function (a, d, b) {
    if (a && this._eventListeners[a]) {
      d = d || {};
      for (var c = this._eventListeners[a], f = 0; f < c.length; f++)
  ...
  z.prototype._updateOptions = function () {
    ...
    this.options.zoomEnabled
      ? (this._zoomButton ||
          ...
          Z(this, this._zoomButton, "pan"),
          this._toolBar.appendChild(this._zoomButton),
          L(this._zoomButton, "click", function () {
            a.zoomEnabled
              ? ((a.zoomEnabled = !1),
                (a.panEnabled = !0),
                Z(a, a._zoomButton, "zoom"))
              : ((a.zoomEnabled = !0),
                (a.panEnabled = !1),
                Z(a, a._zoomButton, "pan"));
            a.render();
          })),
        this._resetButton ||
          ($((this._resetButton = document.createElement("button"))),
          Z(this, this._resetButton, "reset"),
    ...
    this.options.height
      ...
      : (this.height = d =
          0 < this.container.clientHeight
            ? this.container.clientHeight
            : this.height);
    return this.canvas.width !== a * P || this.canvas.height !== d * P
      ? (ta(this.canvas, a, d),
        ta(this.overlaidCanvas, a, d),
        ta(this._eventManager.ghostCanvas, a, d),
        !0)
      : !1;
  };
  z.prototype._initialize = function () {
    ...
    if (this.options.data)
      for (var d = 0; d < this.options.data.length; d++)
        if (
          (a++,
          !this.options.data[d].type ||
            0 <= z._supportedChartTypes.indexOf(this.options.data[d].type))
        ) {
          var b = new ba(
            this,
            this.options.data[d],
  ...
  z.prototype.render = function (a) {
    ...
    b
      ...
      : ($(this._zoomButton, this._resetButton),
        this.options.zoomEnabled &&
          ((this.zoomEnabled = !0), (this.panEnabled = !1)));
    this._processData();
    this.options.title &&
      ((this.title = new oa(this, this.options.title)),
      this.title.dockInsidePlotArea ? d.push(this.title) : this.title.render());
    if (this.options.subtitles)
      for (this.subtitles = [], a = 0; a < this.options.subtitles.length; a++)
        (b = new xa(this, this.options.subtitles[a])),
          this.subtitles.push(b),
          b.dockInsidePlotArea ? d.push(b) : b.render();
    ...
    for (a = 0; a < this.plotInfo.plotTypes.length; a++)
      for (
        var d = this.plotInfo.plotTypes[a], g = 0;
        ...
        h.targetCanvas = null;
        this.animatedRender &&
          ((h.targetCanvas = ia(this.width, this.height)),
          (h.targetCanvasCtx = h.targetCanvas.getContext("2d")));
        "line" === h.type
          ? (l = this.renderLine(h))
          : "stepLine" === h.type
          ? (l = this.renderStepLine(h))
          : "spline" === h.type
          ? (l = this.renderSpline(h))
          : "column" === h.type
          ? (l = this.renderColumn(h))
          : "bar" === h.type
          ? (l = this.renderBar(h))
          : "area" === h.type
          ? (l = this.renderArea(h))
          : "stepArea" === h.type
          ? (l = this.renderStepArea(h))
          : "splineArea" === h.type
          ? (l = this.renderSplineArea(h))
          : "stackedColumn" === h.type
          ? (l = this.renderStackedColumn(h))
          : "stackedColumn100" === h.type
          ? (l = this.renderStackedColumn100(h))
          : "stackedBar" === h.type
          ? (l = this.renderStackedBar(h))
          : "stackedBar100" === h.type
          ? (l = this.renderStackedBar100(h))
          : "stackedArea" === h.type
          ? (l = this.renderStackedArea(h))
          : "stackedArea100" === h.type
          ? (l = this.renderStackedArea100(h))
          : "bubble" === h.type
          ? (l = l = this.renderBubble(h))
          : "scatter" === h.type
          ? (l = this.renderScatter(h))
          : "pie" === h.type
          ? this.renderPie(h)
          : "doughnut" === h.type
          ? this.renderPie(h)
          : "candlestick" === h.type
          ? (l = this.renderCandlestick(h))
          : "ohlc" === h.type
          ? (l = this.renderCandlestick(h))
          : "rangeColumn" === h.type
          ? (l = this.renderRangeColumn(h))
          : "rangeBar" === h.type
          ? (l = this.renderRangeBar(h))
          : "rangeArea" === h.type
          ? (l = this.renderRangeArea(h))
          : "rangeSplineArea" === h.type && (l = this.renderRangeSplineArea(h));
    ...
    this.animatedRender &&
      ...
      ((a = ia(this.width, this.height).getContext("2d")),
      c.push(this.renderIndexLabels(a)));
    var k = this;
    0 < c.length
      ? ((k.disableToolTip = !0),
        k._animator.animate(
          ...
          function (a) {
            ...
            k.ctx.drawImage(
              ...
              0,
              0,
              Math.floor(k.width * P),
              Math.floor(k.height * P),
              0,
              0,
              k.width,
              k.height
            ...
            for (var b = 0; b < c.length; b++)
              (l = c[b]),
                1 > a && "undefined" !== typeof l.startTimePercent
                  ? a >= l.startTimePercent &&
                    l.animationCallback(
                      l.easingFunction(
                        a - l.startTimePercent,
                        0,
                        1,
                        1 - l.startTimePercent
                      ),
                      l
                    )
                  : l.animationCallback(l.easingFunction(a, 0, 1, 1), l);
          ...
          function () {
            ...
            for (var a = 0; a < k.plotInfo.plotTypes.length; a++)
              for (
                var b = k.plotInfo.plotTypes[a], d = 0;
      ...
      : (0 < k._indexLabels.length && k.renderIndexLabels(),
        k.dispatchEvent("dataAnimationIterationEnd", {
          chart: k,
        }));
    ...
    for (var a = "", d = 0; d < this.data.length; d++)
      if (
        ...
        a.dataPoints &&
          ...
          a.visible &&
          0 <= z._supportedChartTypes.indexOf(a.type))
      ) {
        for (
          var b = null, c = !1, f = null, g = !1, h = 0;
  ...
  z.prototype._processMultiseriesPlotUnit = function (a) {
    if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
      for (
        var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = 0;
        ...
        if ("normal" === l.axisPlacement || "xySwapped" === l.axisPlacement)
          var e = a.axisX.sessionVariables.newViewportMinimum
            ...
            r = a.axisX.sessionVariables.newViewportMaximum
              ...
              : Infinity;
        if (
          (l.dataPoints[k].x && l.dataPoints[k].x.getTime) ||
          "dateTime" === l.xValueType
        )
          g = !0;
        for (k = 0; k < l.dataPoints.length; k++) {
          "undefined" === typeof l.dataPoints[k].x &&
            (l.dataPoints[k].x = k + (a.axisX.logarithmic ? 1 : 0));
          l.dataPoints[k].x.getTime
            ? ((g = !0), (c = l.dataPoints[k].x.getTime()))
            : (c = l.dataPoints[k].x);
          f = l.dataPoints[k].y;
          c < b.min && (b.min = c);
          c > b.max && (b.max = c);
          ...
          if (0 < k) {
            if (a.axisX.logarithmic) {
              ...
              (q = c - l.dataPoints[k - 1].x),
                0 > q && (q *= -1),
                b.minDiff > q && 0 !== q && (b.minDiff = q);
            null !== f &&
              null !== l.dataPoints[k - 1].y &&
              (a.axisY.logarithmic
                ? ((q = f / l.dataPoints[k - 1].y),
                  1 > q && (q = 1 / q),
                  d.minDiff > q && 1 !== q && (d.minDiff = q))
                : ((q = f - l.dataPoints[k - 1].y),
                  0 > q && (q *= -1),
                  d.minDiff > q && 0 !== q && (d.minDiff = q)));
          }
          if (c < e && !n) null !== f && (p = c);
          else {
            if (!n && ((n = !0), 0 < k)) {
            ...
            null === f
              ...
              : (f < d.viewPortMin && (d.viewPortMin = f),
                f > d.viewPortMax && (d.viewPortMax = f));
          }
        }
    ...
    if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
      for (
        ...
        for (p = 0; p < m.dataPoints.length; p++) {
          ...
          m.dataPoints[p].x.getTime
            ? ((g = !0), (c = m.dataPoints[p].x.getTime()))
            : (c = m.dataPoints[p].x);
          x(m.dataPoints[p].y)
            ? (f = 0)
            : ((f = m.dataPoints[p].y), 0 === n && (k = Math.min(f, k)));
          c < b.min && (b.min = c);
          c > b.max && (b.max = c);
          if (0 < p) {
            if (a.axisX.logarithmic) {
          ...
          if (c < s && !e) null !== m.dataPoints[p].y && (q = c);
            ...
            m.dataPoints[p].label &&
              (a.axisX.labels[c] = m.dataPoints[p].label);
            c < b.viewPortMin && (b.viewPortMin = c);
            c > b.viewPortMax && (b.viewPortMax = c);
            null === m.dataPoints[p].y
              ? b.viewPortMin === c && q < c && (b.viewPortMin = q)
              : ((a.yTotals[c] =
                  (a.yTotals[c] ? a.yTotals[c] : 0) + Math.abs(f)),
                0 <= f
                  ? (h[c] = h[c] ? h[c] + f : f)
                  : (l[c] = l[c] ? l[c] + f : f));
          }
      ...
      for (p in h)
        h.hasOwnProperty(p) &&
          !isNaN(p) &&
          ((a = h[p]),
          a < d.min && (d.min = Math.min(a, k)),
          a > d.max && (d.max = a),
          p < b.viewPortMin ||
            p > b.viewPortMax ||
            (a < d.viewPortMin && (d.viewPortMin = Math.min(a, k)),
          ...
          if (c < s && !e) null !== f && (q = c);
            ...
            null === f
              ...
              : ((a.yTotals[c] =
                  (a.yTotals[c] ? a.yTotals[c] : 0) + Math.abs(f)),
                0 <= f ? (h = !0) : 0 > f && (l = !0),
                (k[c] = k[c] ? k[c] + Math.abs(f) : Math.abs(f)));
          }
        }
        this.plotInfo.axisXValueType = m.xValueType = g ? "dateTime" : "number";
      }
      a.axisY.logarithmic
        ? ((d.max = x(d.viewPortMax)
            ? 99 * Math.pow(a.axisY.logarithmBase, -0.05)
            : Math.max(
                d.viewPortMax,
                99 * Math.pow(a.axisY.logarithmBase, -0.05)
              )),
          (d.min = x(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)))
        : h && !l
        ? ((d.max = x(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99)),
          (d.min = x(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)))
        : h && l
        ? ((d.max = x(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99)),
          (d.min = x(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)))
        : !h &&
          l &&
          ((d.max = x(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1)),
          (d.min = x(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)));
      d.viewPortMin = d.min;
      d.viewPortMax = d.max;
      a.dataPointYSums = k;
        ...
        if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement)
          var u = this.sessionVariables.axisX.newViewportMinimum
            ...
            w = this.sessionVariables.axisX.newViewportMaximum
              ...
              : Infinity;
        if (
          (n.dataPoints[m].x && n.dataPoints[m].x.getTime) ||
          "dateTime" === n.xValueType
        )
          l = !0;
        for (m = 0; m < n.dataPoints.length; m++) {
          "undefined" === typeof n.dataPoints[m].x &&
            (n.dataPoints[m].x = m + (a.axisX.logarithmic ? 1 : 0));
          n.dataPoints[m].x.getTime
            ? ((l = !0), (c = n.dataPoints[m].x.getTime()))
            : (c = n.dataPoints[m].x);
          ...
          0 < m &&
            ...
            f &&
              null !== f[0] &&
              n.dataPoints[m - 1].y &&
              null !== n.dataPoints[m - 1].y[0] &&
              (a.axisY.logarithmic
                ? ((q = f[0] / n.dataPoints[m - 1].y[0]),
                  1 > q && (q = 1 / q),
                  d.minDiff > q && 1 !== q && (d.minDiff = q))
                : ((q = f[0] - n.dataPoints[m - 1].y[0]),
                  0 > q && (q *= -1),
          ...
          if (!(c < u) || p) {
            ...
            n.dataPoints[m].label &&
              (a.axisX.labels[c] = n.dataPoints[m].label);
            c < b.viewPortMin && (b.viewPortMin = c);
            c > b.viewPortMax && (b.viewPortMax = c);
  ...
  z.prototype.getDataPointAtXY = function (a, d, b) {
    b = b || !1;
    ...
    for (b = 0; b < c.length; b++)
      if (
        ...
        if (
          ((f = S("markerSize", c[b].dataPoint, c[b].dataSeries) || 8),
          c[b].distance <= f / 2)
        ) {
          d = !0;
          break;
  ...
  z.prototype._mouseEventHandler = function (a) {
    ...
    z.capturedEventParam &&
      ((c = z.capturedEventParam),
      "mouseup" === b &&
        ((z.capturedEventParam = null),
          ...
          for (var g = 0; g < this._events.length; g++)
            if (this._events[g].hasOwnProperty(b))
              if (
                ((c = this._events[g]),
                (f = c.bounds),
                d.x >= f.x1 && d.x <= f.x2 && d.y >= f.y1 && d.y <= f.y2)
              ) {
                c[b].call(c.context, d.x, d.y);
                "mousedown" === b && !0 === c.capture
                  ? ((z.capturedEventParam = c),
    ...
    if (
      ...
      if (this.panEnabled || this.zoomEnabled) {
        if (this.panEnabled)
          ...
          2 < Math.abs(b - f) &&
            2 < Math.abs(c - g) &&
            this._zoomPanToSelectedRegion(b, c, f, g) &&
            (h = !0);
        }
        h &&
        ...
        if (this.panEnabled)
          (f = {
            ...
            (h._panTimerId = setTimeout(
              (function (b, c, e, f) {
                return function () {
                  h._zoomPanToSelectedRegion(b, c, e, f, !0) &&
  ...
  z.prototype.validateRegion = function (a, d, b, c, f) {
    ...
    for (
      ...
      this.axisX[p] && g && n.push(this.axisX[p]);
    ...
    for (g = 0; g < n.length; g++) {
      ...
      if (isFinite(h.dataInfo.minDiff))
        if (
          !(
            (h.logarithmic && e / p < Math.pow(h.dataInfo.minDiff, 3)) ||
            (!h.logarithmic &&
              Math.abs(e - p) < 3 * Math.abs(h.dataInfo.minDiff)) ||
            p < h.minimum ||
            e > h.maximum
          )
        )
  ...
  z.prototype.renderIndexLabels = function (a) {
    ...
    for (a = 0; a < this._indexLabels.length; a++) {
      var n = this._indexLabels[a],
        ...
        p,
        e,
        l = S("indexLabelFontColor", n.dataPoint, n.dataSeries),
        k = S("indexLabelFontSize", n.dataPoint, n.dataSeries);
      p = S("indexLabelFontFamily", n.dataPoint, n.dataSeries);
      e = S("indexLabelFontStyle", n.dataPoint, n.dataSeries);
      var h = S("indexLabelFontWeight", n.dataPoint, n.dataSeries),
        ...
        u = x(n.dataPoint.indexLabelLineThickness)
          ? x(n.dataSeries.options.indexLabelLineThickness)
            ? 0
      ...
      var t = n.dataPoint.indexLabelFormatter
        ...
        ? n.dataSeries.indexLabelFormatter(y)
      ...
      if (null !== t && "" !== t) {
        ...
        if (
          ...
          if (
            n.dataPoint.x < aa.viewportMinimum ||
            n.dataPoint.x > aa.viewportMaximum ||
            n.dataPoint.y < ca.viewportMinimum ||
            n.dataPoint.y > ca.viewportMaximum
          )
            continue;
        ...
        f = h = 2;
        "horizontal" === y
          ? ((l = r.width), (k = r.height))
          : ((k = r.width), (l = r.height));
              ...
              0 < C
                ...
                : ((e = n.point.y + h + c),
                  e > g - k - h - c &&
                    ((e =
                      "auto" === w
                        ? Math.min(n.point.y, g) - k - h - c
                        : g - k - h - c),
                    (z = e < n.point.y))))
            : ((f = Math.max(n.bounds.y1, b.y1)),
              (g = Math.min(n.bounds.y2, b.y2)),
              (c =
                0 <= m.indexOf("range")
                  ? 0 < C
                    ? Math.max(n.bounds.y1, b.y1) + k / 2 + h
                    : Math.min(n.bounds.y2, b.y2) - k / 2 - h
                  : (Math.max(n.bounds.y1, b.y1) +
                      Math.min(n.bounds.y2, b.y2)) /
                    2),
              0 < C
                ? ((e = Math.max(n.point.y, c) - k / 2),
                  e < f &&
                    ("bubble" === m || "scatter" === m) &&
                    (e = Math.max(n.point.y - k - h, b.y1 + h)))
                : ((e = Math.min(n.point.y, c) - k / 2),
                  e > g - k - h &&
                    ("bubble" === m || "scatter" === m) &&
                ...
                0 > C
                  ...
                  : ((p = n.point.x + f + c),
                    p > g - l - f - c &&
                      ((p =
                        "auto" === w
                          ? Math.min(n.point.x, g) - l - f - c
                          : g - l - f - c),
                      (z = p < n.point.x))))
              : ((h = Math.max(n.bounds.x1, b.x1)),
                Math.min(n.bounds.x2, b.x2),
                (c =
                  0 <= m.indexOf("range")
                    ? 0 > C
                      ? Math.max(n.bounds.x1, b.x1) + l / 2 + f
                      : Math.min(n.bounds.x2, b.x2) - l / 2 - f
                    : (Math.max(n.bounds.x1, b.x1) +
                        Math.min(n.bounds.x2, b.x2)) /
                      2),
                (p =
                  0 > C
                    ? Math.max(n.point.x, c) - l / 2
                    : Math.min(n.point.x, c) - l / 2),
                (p = Math.max(p, h)));
        "vertical" === y && (e += k);
        r.x = p;
        r.y = e;
        ...
        u &&
          "inside" !== w &&
          ((0 > m.indexOf("bar") && n.point.x > b.x1 && n.point.x < b.x2) ||
            !z) &&
          ((0 > m.indexOf("column") && n.point.y > b.y1 && n.point.y < b.y2) ||
            !z) &&
          ((d.lineWidth = u),
          (d.strokeStyle = s ? s : "gray"),
          d.setLineDash && d.setLineDash(F(q, u)),
          d.beginPath(),
          d.moveTo(n.point.x, n.point.y),
          0 <= m.indexOf("bar")
            ? d.lineTo(
                p + (0 < n.direction ? 0 : l),
                e + ("horizontal" === y ? k : -k) / 2
              )
            : 0 <= m.indexOf("column")
            ? d.lineTo(
                p + l / 2,
                e +
                  ((0 < n.direction ? k : -k) + ("horizontal" === y ? k : -k)) /
                    2
              )
            : d.lineTo(
                p + l / 2,
                e +
                  ((e < n.point.y ? k : -k) + ("horizontal" === y ? k : -k)) / 2
              ),
          d.stroke());
      }
    }
    ...
    for (a = 0; a < this._indexLabels.length; a++)
      (n = this._indexLabels[a]),
        (r = S("indexLabelBackgroundColor", n.dataPoint, n.dataSeries)),
        (n.dataSeries.indexLabelBackgroundColor = x(r)
          ? v
            ? "transparent"
            : null
          : r);
      ...
      for (var c = [], f = null, g = 0; g < a.dataSeriesIndexes.length; g++) {
        ...
        var e = l._colorSet,
          r =
            (e =
            l.lineColor =
              l.options.lineColor ? l.options.lineColor : e[0]);
        d.strokeStyle = e;
        var q = !0,
          s = 0,
          u,
        ...
        if (0 < k.length) {
          for (var y = !1, s = 0; s < k.length; s++)
            if (
              ((u = k[s].x.getTime ? k[s].x.getTime() : k[s].x),
              !(
                u < a.axisX.dataInfo.viewPortMin ||
                (u > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !y))
              ))
            )
              if ("number" !== typeof k[s].y)
                0 < s &&
                  !(l.connectNullData || y || q) &&
                  (d.stroke(), v && b.stroke()),
                  (y = !0);
              else {
                ...
                q || y
                  ? (!q && l.connectNullData
                      ? (d.setLineDash &&
                          ...
                          (d.stroke(),
                          (n = l.nullDataLineDashType),
                          d.setLineDash(m)),
                        d.lineTo(u, w),
                        v && b.lineTo(u, w))
                      : (d.beginPath(),
                        d.moveTo(u, w),
                        v && (b.beginPath(), b.moveTo(u, w))),
                    (y = q = !1))
                  : (d.lineTo(u, w),
                    v && b.lineTo(u, w),
                    0 == s % 500 &&
                      ...
                      d.beginPath(),
                      d.moveTo(u, w),
                      v && (b.stroke(), b.beginPath(), b.moveTo(u, w))));
                s < k.length - 1 &&
                  (r !== (k[s].lineColor || e) ||
                    n !== (k[s].lineDashType || l.lineDashType)) &&
                  (d.stroke(),
                  d.beginPath(),
                  d.moveTo(u, w),
                  (r = k[s].lineColor || e),
                  ...
                  d.setLineDash &&
                    (k[s].lineDashType
                      ? ((n = k[s].lineDashType),
                        d.setLineDash(F(n, l.lineThickness)))
                      : ((n = l.lineDashType), d.setLineDash(p))));
    ...
    if (!(0 >= a.dataSeriesIndexes.length)) {
      ...
      for (var c = [], f = null, g = 0; g < a.dataSeriesIndexes.length; g++) {
        ...
        if (0 < k.length) {
          for (var y = !1, s = 0; s < k.length; s++)
            if (
              ((u = k[s].getTime ? k[s].x.getTime() : k[s].x),
              !(
                u < a.axisX.dataInfo.viewPortMin ||
                (u > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !y))
              ))
                ...
                s < k.length - 1 &&
                  ...
                  d.setLineDash &&
                    (k[s].lineDashType
                      ...
                      : ((n = l.lineDashType), d.setLineDash(p))));
                if (0 < k[s].markerSize || 0 < l.markerSize)
                  (t = l.getMarkerProperties(s, u, w, d)),
                    (f = t.color),
                    c.push(t),
                    (C = D(C)),
                    v &&
      ...
      if (0 < a.length) {
        ...
        for (var d = 0; d < a.length - 3; d += 3)
          if (
            ...
            (0 < d && 0 === d % 3e3) ||
              a[d + 3].newStrokeStyle ||
              a[d + 3].newLineDashArray)
          )
            b.stroke(),
              b.beginPath(),
              b.moveTo(a[d + 3].x, a[d + 3].y),
              a[d + 3].newStrokeStyle &&
                (b.strokeStyle = a[d + 3].newStrokeStyle),
              a[d + 3].newLineDashArray &&
                b.setLineDash(a[d + 3].newLineDashArray),
              v &&
                (c.stroke(), c.beginPath(), c.moveTo(a[d + 3].x, a[d + 3].y));
        b.stroke();
        v && c.stroke();
      }
    }
      ...
      for (var f = [], g = null, h = 0; h < a.dataSeriesIndexes.length; h++) {
        ...
        if (0 < n.length)
          for (w = !1, s = 0; s < n.length; s++)
            if (
              ((u = n[s].getTime ? n[s].x.getTime() : n[s].x),
              !(
                u < a.axisX.dataInfo.viewPortMin ||
                (u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !w))
              ))
            )
              if ("number" !== typeof n[s].y)
                  ...
                  (k.connectNullData
                    ? b.setLineDash &&
                      ...
                      (k.options.nullDataLineDashType ||
                        !n[s - 1].lineDashType) &&
                      ((y[y.length - 1].newLineDashArray = p),
                ...
                s < n.length - 1 &&
                  (q !== (n[s].lineColor || r) ||
                    m !== (n[s].lineDashType || k.lineDashType)) &&
                  ((q = n[s].lineColor || r),
                  (y[y.length - 1].newStrokeStyle = q),
                  b.setLineDash &&
                    (n[s].lineDashType
                      ? ((m = n[s].lineDashType),
                        (y[y.length - 1].newLineDashArray = F(
                          m,
                          k.lineThickness
                        )))
                      : ((m = k.lineDashType),
  ...
  var R = function (a, d, b, c, f, g, h, l, k, n, m, p, e) {
    ...
    0 < h &&
      ...
      (a.strokeStyle = l),
      a.moveTo(d, b),
      a.rect(d - e, b - e, c - d + 2 * e, f - b + 2 * e),
      a.stroke());
    a.restore();
    !0 === k &&
      (a.save(),
      ...
      a.lineTo(c, b),
      a.closePath(),
      (h = a.createLinearGradient((c + d) / 2, b + r, (c + d) / 2, b)),
      h.addColorStop(0, g),
    ...
    !0 === n &&
      ...
      a.lineTo(c, f),
      a.closePath(),
      (h = a.createLinearGradient((c + d) / 2, f - r, (c + d) / 2, f)),
      h.addColorStop(0, g),
      h.addColorStop(1, "rgba(255, 255, 255, .4)"),
      (a.fillStyle = h),
      a.fill(),
    ...
    !0 === m &&
      ...
      a.lineTo(d, f),
      a.closePath(),
      (h = a.createLinearGradient(d + r, (f + b) / 2, d, (f + b) / 2)),
      h.addColorStop(0, g),
    ...
    !0 === p &&
      ...
      a.lineTo(c - r, f - r),
      a.lineTo(c, f),
      (h = a.createLinearGradient(c - r, (f + b) / 2, c, (f + b) / 2)),
      h.addColorStop(0, g),
      h.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
      (a.fillStyle = h),
      h.addColorStop(0, g),
  ...
  z.prototype.renderColumn = function (a) {
    ...
    if (!(0 >= a.dataSeriesIndexes.length)) {
      var b = null,
        ...
        f = (this.dataPointMinWidth = this.dataPointMinWidth
      ...
      this.dataPointMaxWidth &&
        f > n &&
        (f = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, n));
      !this.dataPointMaxWidth &&
        this.dataPointMinWidth &&
        n < f &&
        (n = Math.max(
      ...
      for (c = 0; c < a.dataSeriesIndexes.length; c++) {
        ...
        if (0 < e.length)
          for (
            var r = 5 < m && p.bevelEnabled ? !0 : !1, f = 0;
            f < e.length;
            f++
          )
            if (
              (e[f].getTime ? (l = e[f].x.getTime()) : (l = e[f].x),
              !(
  ...
  z.prototype.renderStackedColumn = function (a) {
    ...
    if (!(0 >= a.dataSeriesIndexes.length)) {
      ...
      this.dataPointMaxWidth &&
        l > m &&
        (l = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, m));
      !this.dataPointMaxWidth &&
        this.dataPointMinWidth &&
        m < l &&
        (m = Math.max(
      ...
      for (m = 0; m < a.dataSeriesIndexes.length; m++) {
        ...
        if (0 < q.length) {
          ...
          for (l = 0; l < q.length; l++)
            if (
              ((b = q[l].x.getTime ? q[l].x.getTime() : q[l].x),
              !(
              ...
              var c = a.axisX.convertValueToPixel(b),
                u =
                  (c - (a.plotType.plotUnits.length * p) / 2 + a.index * p) <<
                  0,
                w = (u + p) << 0,
                y;
              if (a.axisY.logarithmic)
                ...
                ((k = a.axisY.convertValueToPixel(q[l].y)), 0 <= q[l].y)
              ) {
                var t = f[b] ? f[b] : 0;
                k -= t;
                y = n - t;
  ...
  z.prototype.renderStackedColumn100 = function (a) {
    ...
    if (!(0 >= a.dataSeriesIndexes.length)) {
      ...
      for (m = 0; m < a.dataSeriesIndexes.length; m++) {
        ...
        if (0 < q.length)
          for (
            var s = 5 < p && r.bevelEnabled ? !0 : !1, l = 0;
            l < q.length;
            l++
          )
            if (
            ...
            if (
              ...
              if (a.axisY.logarithmic) {
                ...
                (t = g[b] ? g[b] : 0),
                  ...
                  (g[b] = t + (k - u));
              b = q[l].color ? q[l].color : r._colorSet[l % r._colorSet.length];
              R(d, u, w, k, y, b, 0, null, s, !1, !1, !1, r.fillOpacity);
              b = r.dataPointIds[l];
              this._eventManager.objectMap[b] = {
                id: b,
                objectType: "dataPoint",
    ...
    function d() {
      t &&
        ...
        (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum)
          ...
          ? (y = g.y1)
          : 0 < a.axisY.viewportMinimum && (y = f.y2),
        b.lineTo(q, y),
        b.lineTo(t.x, y),
        b.closePath(),
        ...
        b.fill(),
        (b.globalAlpha = 1),
        v && (c.lineTo(q, y), c.lineTo(t.x, y), c.closePath(), c.fill()),
        b.beginPath(),
        b.moveTo(q, s),
        c.beginPath(),
        c.moveTo(q, s),
      ...
      for (k = 0; k < a.dataSeriesIndexes.length; k++) {
        ...
        if (0 < p.length) {
          ...
          for (var I = !0; r < p.length; r++)
            if (
              ((u = p[r].x.getTime ? p[r].x.getTime() : p[r].x),
              !(
                u < a.axisX.dataInfo.viewPortMin ||
                (u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !I))
              ))
            )
              if ("number" !== typeof p[r].y)
                m.connectNullData || I || e || d(), (I = !0);
              else {
                ...
                e || I
                  ? (!e && m.connectNullData
                      ...
                      : (b.beginPath(),
                        b.moveTo(q, s),
                        v && (c.beginPath(), c.moveTo(q, s)),
                        (t = {
                          x: q,
                          y: s,
                        })),
                    (I = e = !1))
                  : (b.lineTo(q, s), v && c.lineTo(q, s), 0 == r % 250 && d());
                r < p.length - 1 &&
                  (ca !== (p[r].lineColor || x) ||
                  ...
                  b.setLineDash &&
                    (p[r].lineDashType
                      ? ((z = p[r].lineDashType),
                        b.setLineDash(F(z, m.lineThickness)))
                      : ((z = m.lineDashType), b.setLineDash(K))));
                ...
                0 !== p[r].markerSize &&
                  ...
                  ((u = m.getMarkerProperties(r, q, s, b)),
                  (l = u.color),
                  h.push(u),
                  (G = D(G)),
                  v &&
    ...
    function d() {
      ...
      if (0 < d.length) {
        if (0 < m.lineThickness) {
          ...
          for (var e = 0; e < d.length - 3; e += 3)
            if (
              ...
              d[e + 3].newStrokeStyle || d[e + 3].newLineDashArray)
            )
              b.stroke(),
                b.beginPath(),
                b.moveTo(d[e + 3].x, d[e + 3].y),
                d[e + 3].newStrokeStyle &&
                  (b.strokeStyle = d[e + 3].newStrokeStyle),
                d[e + 3].newLineDashArray &&
                  b.setLineDash(d[e + 3].newLineDashArray);
          b.stroke();
        }
        b.beginPath();
        b.moveTo(d[0].x, d[0].y);
        ...
        (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum)
          ...
          : 0 > a.axisY.viewportMaximum
          ? (u = g.y1)
          : 0 < a.axisY.viewportMinimum && (u = f.y2);
        w = {
          x: d[0].x,
          y: d[0].y,
        };
      ...
      for (k = 0; k < a.dataSeriesIndexes.length; k++) {
        ...
        if (0 < p.length) {
          ...
          for (q = !1; e < p.length; e++)
            if (
              ((r = p[e].x.getTime ? p[e].x.getTime() : p[e].x),
              !(
                r < a.axisX.dataInfo.viewPortMin ||
                (r > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !q))
              ))
            )
              if ("number" !== typeof p[e].y)
                ...
                e < p.length - 1 &&
                  (x !== (p[e].lineColor || C) ||
                    z !== (p[e].lineDashType || m.lineDashType)) &&
                  ((x = p[e].lineColor || C),
                  (y[y.length - 1].newStrokeStyle = x),
                  b.setLineDash &&
                    (p[e].lineDashType
                      ? ((z = p[e].lineDashType),
                        (y[y.length - 1].newLineDashArray = F(
                ...
                if (
                  0 !== p[e].markerSize &&
                  (0 < p[e].markerSize || 0 < m.markerSize)
                ) {
        ...
        if (0 < p.length) {
          ...
          for (; r < p.length; r++)
            if (
              ...
              !(
                u < a.axisX.dataInfo.viewPortMin ||
                (u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !C))
              ))
            ) {
              var G = s;
              "number" !== typeof p[r].y
                ? (m.connectNullData || C || e || d(), (C = !0))
                : ((q = a.axisX.convertValueToPixel(u)),
                  (s = a.axisY.convertValueToPixel(p[r].y)),
                  e || C
                    ? (!e && m.connectNullData
                  ...
                  r < p.length - 1 &&
                    (A !== (p[r].lineColor || z) ||
                      Q !== (p[r].lineDashType || m.lineDashType)) &&
                    (d(),
                    (A = p[r].lineColor || z),
                    (b.strokeStyle = A),
                    b.setLineDash &&
                      (p[r].lineDashType
                        ? ((Q = p[r].lineDashType),
                          b.setLineDash(F(Q, m.lineThickness)))
                        : ((Q = m.lineDashType), b.setLineDash(I)))),
                  (G = m.dataPointIds[r]),
                  (this._eventManager.objectMap[G] = {
                    id: G,
                    objectType: "dataPoint",
    ...
    if (!(0 >= a.dataSeriesIndexes.length)) {
      ...
      for (var w = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
        ...
        for (p = 0; p < C.length; p++)
          (y = C[p].x.getTime ? C[p].x.getTime() : C[p].x),
            (t.dataPointIndexes[y] = p),
            w[y] || (n.push(y), (w[y] = !0));
        n.sort(Aa);
      }
      for (h = 0; h < a.dataSeriesIndexes.length; h++) {
        ...
        if (0 < n.length) {
          ...
          var A = "solid";
          if (b.setLineDash) {
            var Q = F(t.nullDataLineDashType, t.lineThickness),
              A = t.lineDashType,
          ...
          for (var I = !0, p = 0; p < n.length; p++) {
            ...
            var G = null,
              G =
                0 <= t.dataPointIndexes[q]
                  ? C[t.dataPointIndexes[q]]
                  : {
                      x: q,
                      y: null,
                    };
            if (
              !(
                ...
                (q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !I))
              )
            )
              if ("number" !== typeof G.y)
                t.connectNullData || I || w || d(), (I = !0);
              else {
                ...
                } else (r = a.axisY.convertValueToPixel(G.y)), (r -= ga);
                k.push({
                  x: e,
                  y: s - ga,
                });
                ...
                w || I
                  ? (!w && t.connectNullData
                      ? (b.setLineDash &&
                          ...
                          (b.stroke(),
                          (A = t.nullDataLineDashType),
                          b.setLineDash(Q)),
                        b.lineTo(e, r),
                        v && u.lineTo(e, r))
                      : (b.beginPath(),
                        b.moveTo(e, r),
                        v && (u.beginPath(), u.moveTo(e, r))),
                    (I = w = !1))
                  : (b.lineTo(e, r),
                    v && u.lineTo(e, r),
                    0 == p % 250 &&
                ...
                p < C.length - 1 &&
                  (z !== (C[p].lineColor || x) ||
                    A !== (C[p].lineDashType || t.lineDashType)) &&
                  (d(),
                  b.beginPath(),
                  b.moveTo(e, r),
                  k.push({
                  ...
                  b.setLineDash &&
                    (C[p].lineDashType
                      ? ((A = C[p].lineDashType),
                        b.setLineDash(F(A, t.lineThickness)))
                      : ((A = t.lineDashType), b.setLineDash(K))));
                ...
                0 <= t.dataPointIndexes[q] &&
                  0 !== G.markerSize &&
                  (0 < G.markerSize || 0 < t.markerSize) &&
                  ((q = t.getMarkerProperties(p, e, r, b)),
                  (g = q.color),
                  f.push(q),
                  (markerColor = D(ha)),
                  v &&
    ...
    if (!(0 >= a.dataSeriesIndexes.length)) {
      ...
      for (var w = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
        ...
        for (p = 0; p < x.length; p++)
          (y = x[p].x.getTime ? x[p].x.getTime() : x[p].x),
            (t.dataPointIndexes[y] = p),
            w[y] || (n.push(y), (w[y] = !0));
        n.sort(Aa);
      }
          ...
          for (var I = !0, p = 0; p < n.length; p++) {
            ...
            if (
              ...
              if ("number" !== typeof G.y)
                ...
                var ga;
                ga =
                  0 !== a.dataPointYSums[q]
                    ? 100 * (G.y / a.dataPointYSums[q])
                    : 0;
                e = a.axisX.convertValueToPixel(q);
                var ha = l[q] ? l[q] : 0;
                if (a.axisY.logarithmic) {
                ...
                p < x.length - 1 &&
                  (A !== (x[p].lineColor || z) ||
                    T !== (x[p].lineDashType || t.lineDashType)) &&
                  (d(),
                  b.beginPath(),
                  b.moveTo(e, r),
                  k.push({
                  ...
                  b.setLineDash &&
                    (x[p].lineDashType
                      ? ((T = x[p].lineDashType),
                        b.setLineDash(F(T, t.lineThickness)))
                      : ((T = t.lineDashType), b.setLineDash(K))));
                if (0 <= t.dataPointIndexes[q]) {
    ...
    if (!(0 >= a.dataSeriesIndexes.length)) {
      ...
      for (
        ...
        for (
          ...
          (f = p[c].getTime ? (f = p[c].x.getTime()) : (f = p[c].x)),
            f < a.axisX.dataInfo.viewPortMin ||
              f > a.axisX.dataInfo.viewPortMax ||
              "undefined" === typeof p[c].z ||
              ((e = p[c].z), e > h && (h = e), e < l && (l = e));
      for (
        var r = 25 * Math.PI,
          b = Math.max(
      ...
      for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
        ...
        if (0 < n.length) {
          ...
          for (var m = 0, p = 0, c = 0; c < n.length; c++)
            if (
              ((f = n[c].getTime ? (f = n[c].x.getTime()) : (f = n[c].x)),
              !(
                f < a.axisX.dataInfo.viewPortMin ||
                f > a.axisX.dataInfo.viewPortMax
              ) && "number" === typeof n[c].y)
  ...
  z.prototype.renderCandlestick = function (a) {
    ...
    if (!(0 >= a.dataSeriesIndexes.length)) {
      ...
      for (var e = 0; e < a.dataSeriesIndexes.length; e++) {
        ...
        if (0 < s.length)
          for (
            var u = 5 < p && q.bevelEnabled ? !0 : !1, f = 0;
            f < s.length;
            f++
          )
            if (
              (s[f].getTime ? (m = s[f].x.getTime()) : (m = s[f].x),
              !(
                ...
                "number" === typeof s[f].y[2] &&
                "number" === typeof s[f].y[3])
            ) {
              ...
              "candlestick" === q.type
                ? (d.moveTo(g - x, l),
                  d.lineTo(g - x, Math.min(h, n)),
                  d.stroke(),
                  d.moveTo(g - x, Math.max(h, n)),
                  d.lineTo(g - x, k),
                  d.stroke(),
                  R(
                    d,
                    ...
                    y,
                    Math.max(h, n),
                    s[f].y[0] <= s[f].y[3] ? q.risingColor : c,
                    t,
                    c,
                    u,
                    u,
                  ...
                  v &&
                    ...
                    (b.strokeStyle = c),
                    b.moveTo(g - x, l),
                    b.lineTo(g - x, Math.min(h, n)),
                    b.stroke(),
                    b.moveTo(g - x, Math.max(h, n)),
                    b.lineTo(g - x, k),
                    b.stroke(),
                    R(
                      b,
  ...
  z.prototype.renderRangeColumn = function (a) {
    ...
    if (!(0 >= a.dataSeriesIndexes.length)) {
      ...
      for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
        ...
        if (0 < p.length)
          for (
            var e = 5 < l && m.bevelEnabled ? !0 : !1, f = 0;
            f < p.length;
            f++
          )
            if (
              (p[f].getTime ? (h = p[f].x.getTime()) : (h = p[f].x),
              !(
              ...
              var r = a.axisX.reversed
                ...
                b = p[f].color
                  ? p[f].color
                  : m._colorSet[f % m._colorSet.length];
              if (c > g) {
                var s = c,
                  c = g;
                g = s;
          ...
          for (f = 0; f < e.length; f++)
            if (
              ...
              !(
                ...
                null !== e[f].y &&
                e[f].y.length &&
                "number" === typeof e[f].y[0] &&
                "number" === typeof e[f].y[1])
            ) {
      ...
      for (h = 0; h < a.dataSeriesIndexes.length; h++) {
        ...
        if (0 < m.length) {
          ...
          for (var Q = !0; e < m.length; e++)
            if (
              ((u = m[e].x.getTime ? m[e].x.getTime() : m[e].x),
              !(
                u < a.axisX.dataInfo.viewPortMin ||
                (u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !Q))
              ))
            )
              if (
                null !== m[e].y &&
                ...
                e < m.length - 1 &&
                  (x !== (m[e].lineColor || t) ||
                    z !== (m[e].lineDashType || n.lineDashType)) &&
                  (d(),
                  (x = m[e].lineColor || t),
                  (l[l.length - 1].newStrokeStyle = x),
                  (b.strokeStyle = x),
                  b.setLineDash &&
                    (m[e].lineDashType
                      ? ((z = m[e].lineDashType),
                ...
                if (
                  0 !== m[e].markerSize &&
                  (0 < m[e].markerSize || 0 < n.markerSize)
                ) {
                ...
                if (
                  ...
                  this._indexLabels.push({
                    ...
                    direction:
                      m[e].y[0] > m[e].y[1] === a.axisY.reversed ? -1 : 1,
                    color: y,
                  }),
                    this._indexLabels.push({
                      chartType: "rangeArea",
      ...
      for (h = 0; h < a.dataSeriesIndexes.length; h++) {
        ...
        if (0 < n.length) {
          var u = k._colorSet[m % k._colorSet.length],
            w = (k.lineColor = k.options.lineColor || u),
            y = w;
          b.fillStyle = u;
          b.lineWidth = k.lineThickness;
          var t = "solid",
          ...
          for (e = !1; m < n.length; m++)
            if (
              ((p = n[m].x.getTime ? n[m].x.getTime() : n[m].x),
              !(
                p < a.axisX.dataInfo.viewPortMin ||
                (p > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !e))
              ))
            )
              if (
                null !== n[m].y &&
                n[m].y.length &&
                "number" === typeof n[m].y[0] &&
                "number" === typeof n[m].y[1]
              ) {
                ...
                m < n.length - 1 &&
                  (y !== (n[m].lineColor || w) ||
                    t !== (n[m].lineDashType || k.lineDashType)) &&
                  ((y = n[m].lineColor || w),
                  (q[q.length - 1].newStrokeStyle = y),
                  b.setLineDash &&
                    (n[m].lineDashType
                      ? ((t = n[m].lineDashType),
                      ...
                      : ((t = k.lineDashType),
                        (q[q.length - 1].newLineDashArray = x))));
                if (
                  0 !== n[m].markerSize &&
  ...
  z.prototype.renderPie = function (a) {
      ...
      if (n && m) {
        for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < m.length; f++) {
          ...
          p = g.indexLabelFormatter
            ...
            : g.indexLabel
            ? k.replaceKeywordsWithValue(g.indexLabel, g, n, f)
            : n.indexLabelFormatter
            ? n.indexLabelFormatter(q)
            : n.indexLabel
            ? k.replaceKeywordsWithValue(n.indexLabel, g, n, f)
            : g.label
            ? g.label
            : "";
          ...
          l.indexLabelLineColor = g.indexLabelLineColor
            ...
            : g.color
            ? g.color
            : n._colorSet[f % n._colorSet.length];
          ...
          l.indexLabelFontSize = g.indexLabelFontSize
    ...
    function b(a) {
      ...
      for (b = 0; b < m.length; b++) {
        ...
        if (d > c) {
          ...
          if (m[b].exploded) {
            if (
              1e-9 < Math.abs(r[b].center.x - (t.x + f)) ||
              1e-9 < Math.abs(r[b].center.y - (t.y + g))
            )
              (r[b].center.x = t.x + f * a),
                (r[b].center.y = t.y + g * a),
                (l = !0);
          } else if (
            0 < Math.abs(r[b].center.x - t.x) ||
            0 < Math.abs(r[b].center.y - t.y)
          )
            (r[b].center.x = t.x + f * (1 - a)),
              (r[b].center.y = t.y + g * (1 - a)),
              (l = !0);
          l &&
            ((f = {}),
            (f.dataSeries = n),
            (f.dataPoint = n.dataPoints[b]),
            (f.index = b),
            k.toolTip.highlightObjects([f]));
          Ha(
            k.plotArea.ctx,
            r[b].center,
            r[b].radius,
            m[b].color ? m[b].color : n._colorSet[b % n._colorSet.length],
            n.type,
            c,
            d,
            n.fillOpacity,
    ...
    function f(a) {
      for (var b = null, d = 1; d < m.length; d++)
        if (
          ((b = (a + d + r.length) % r.length),
          r[b].hemisphere !== r[a].hemisphere)
        ) {
          b = null;
          break;
        } else if (
          ...
          b !== a &&
          (0 > c(r[b], r[a]) ||
            ("right" === r[a].hemisphere
              ? r[b].indexLabelTextBlock.y >= r[a].indexLabelTextBlock.y
              : r[b].indexLabelTextBlock.y <= r[a].indexLabelTextBlock.y))
        )
          break;
        else b = null;
    ...
    function g(a, b, d) {
      ...
      if (0 <= a && a < m.length) {
        var h = r[a];
        if (
          (0 > b && h.indexLabelTextBlock.y < k) ||
          (0 < b && h.indexLabelTextBlock.y > l)
        )
          return 0;
        var n = 0,
          p = 0,
        ...
        k =
          "right" === h.hemisphere
            ? t.x + Math.sqrt(Math.pow(s, 2) - Math.pow(b - t.y, 2))
            : t.x - Math.sqrt(Math.pow(s, 2) - Math.pow(b - t.y, 2));
        ...
        for (l = 1; l < m.length; l++)
          if (
            ((k = (a - l + r.length) % r.length),
            r[k].hemisphere !== r[a].hemisphere)
          ) {
            k = null;
            break;
          } else if (
            ...
            (0 > c(r[k], r[a]) ||
              ("right" === r[a].hemisphere
                ? r[k].indexLabelTextBlock.y <= r[a].indexLabelTextBlock.y
                : r[k].indexLabelTextBlock.y >= r[a].indexLabelTextBlock.y))
          )
            break;
          else k = null;
          ...
          ? ((l = "right" === h.hemisphere ? p : n),
            ...
            null !== l &&
              ...
              (b =
                h.indexLabelTextBlock.y -
                h.indexLabelTextBlock.height / 2 -
                (r[l].indexLabelTextBlock.y +
                  r[l].indexLabelTextBlock.height / 2)),
              b - p < q &&
                ((k = -p),
                (l = g(l, k, d + 1)),
                +l.toFixed(y) > +k.toFixed(y) &&
                  (e = b > q ? -(b - q) : -(p - (l - k))))))
          : 0 < b &&
            ((l = "right" === h.hemisphere ? n : p),
            (e = b),
            null !== l &&
              ((p = b),
              (b =
              ...
              b - p < q &&
                ...
                +l.toFixed(y) < +k.toFixed(y) &&
                  (e = b > q ? b - q : p - (k - l)))));
        e &&
          ((d = h.indexLabelTextBlock.y + e),
          (b = 0),
          (b =
            "right" === h.hemisphere
              ? t.x + Math.sqrt(Math.pow(s, 2) - Math.pow(d - t.y, 2))
              : t.x - Math.sqrt(Math.pow(s, 2) - Math.pow(d - t.y, 2))),
          h.midAngle > Math.PI / 2 - w && h.midAngle < Math.PI / 2 + w
            ? ((k = (a - 1 + r.length) % r.length),
              (k = r[k]),
              (a = r[(a + 1 + r.length) % r.length]),
              "left" === h.hemisphere &&
              "right" === k.hemisphere &&
          ...
          (h.indexLabelTextBlock.x = b),
          (h.indexLabelAngle = Math.atan2(
            h.indexLabelTextBlock.y - t.y,
            h.indexLabelTextBlock.x - t.x
          )));
      }
      return e;
    }
    function h() {
      ...
      for (
        ...
        if (
          n.radius ||
          (!n.radius &&
            "undefined" !== typeof n.innerRadius &&
            null !== n.innerRadius &&
            A - d <= E)
        )
          l = !1;
        ...
        if ("inside" !== n.indexLabelPlacement) {
          ...
          for (var w, v, a = 0; a < m.length; a++) {
            ...
            if (null !== x) {
              ...
              var z = 0,
                z = c(w, v) - q;
              if (0 > z) {
                for (var C = (v = 0), D = 0; D < m.length; D++)
                  D !== a &&
                    r[D].hemisphere === h.hemisphere &&
                    (r[D].indexLabelTextBlock.y < h.indexLabelTextBlock.y
                      ? v++
                      : C++);
                v = (z / (v + C || 1)) * C;
                var C = -1 * (z - v),
                ...
                "right" === h.hemisphere
                  ? ((D = g(a, v)),
                    (C = -1 * (z - D)),
                    (B = g(x, C)),
                    +B.toFixed(y) < +C.toFixed(y) &&
                      +D.toFixed(y) <= +v.toFixed(y) &&
                      g(a, -(C - B)))
                  : ((D = g(x, v)),
                    (C = -1 * (z - D)),
                    (B = g(a, C)),
          ...
          for (a = 0; a < m.length; a++)
            (h = r[a]),
              (s = "pie" === n.type ? 0.7 * A : 0.8 * A),
              (x = t.x + s * Math.cos(h.midAngle)),
              (v = t.y + s * Math.sin(h.midAngle)),
              (h.indexLabelTextBlock.x = x),
              (h.indexLabelTextBlock.y = v);
        for (a = 0; a < m.length; a++)
          if (
            ((h = r[a]),
            ...
            (x = x = 0),
              ...
              0 < x &&
                (!l &&
                  ...
                  ((v =
                    "right" === h.hemisphere
                      ? e.x2 - h.indexLabelTextBlock.x
                      : h.indexLabelTextBlock.x - e.x1),
                  0.3 * h.indexLabelTextBlock.maxWidth > v
                    ? (h.indexLabelText = "")
                    : (h.indexLabelTextBlock.maxWidth = 0.85 * v),
                  0.3 * h.indexLabelTextBlock.maxWidth < v &&
                    (h.indexLabelTextBlock.x -=
                ...
                ((x /= Math.abs(Math.cos(h.indexLabelAngle))),
                9 < x && (x *= 0.3),
                x > d && (d = x)),
              (x = x = 0),
                ...
                (!l &&
                  ...
                  ((v =
                    0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI
                      ...
                      : 1),
                  0 === g(a, x * v) && g(a, 2 * v)),
                Math.abs(h.indexLabelTextBlock.x - t.x) < A &&
                  ((x /= Math.abs(Math.sin(h.indexLabelAngle))),
                  9 < x && (x *= 0.3),
                  x > d && (d = x)));
            ...
            if (((e = !1), (w = r[g]), w.indexLabelText)) {
              ...
              if (null !== h) {
                ...
                if ((l = 0 > z)) {
                  ...
                  var n =
                      w.indexLabelTextBlock.y -
                      w.indexLabelTextBlock.height / 2,
                    q =
                      w.indexLabelTextBlock.y +
                      w.indexLabelTextBlock.height / 2,
                    s =
                    ...
                    u =
                      ...
                      k.indexLabelTextBlock.height / 2;
                  l =
                    w.indexLabelTextBlock.x + w.indexLabelTextBlock.width <
                ...
                l
                  ? (0 > a && (a = g),
                    h !== a && ((b = h), (d += -z)),
                    0 === g % Math.max(m.length / 10, 3) && (e = !0))
                  : (e = !0);
                e &&
                  0 < d &&
                  0 <= a &&
    ...
    if (!(0 >= a.dataSeriesIndexes.length)) {
      ...
      if (0 !== v) {
        a =
          a ||
          ("undefined" !== typeof n.indexLabel &&
            null !== n.indexLabel &&
            0 < n.indexLabel.toString().length);
        var A =
          "inside" !== n.indexLabelPlacement && a
            ? (0.75 * Math.min(e.width, e.height)) / 2
            : (0.92 * Math.min(e.width, e.height)) / 2;
        n.radius && (A = Pa(n.radius, A));
        var E =
          "undefined" !== typeof n.innerRadius && null !== n.innerRadius
            ? Pa(n.innerRadius, A)
            : 0.7 * A;
        n.radius = A;
        ...
        this.pieDoughnutClickHandler = function (a) {
          k.isAnimating ||
            (!x(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick) ||
            ((a = a.dataPoint),
        ...
        this._animator.animate(
          ...
          function (a) {
            ...
            for (b = 0; b < m.length; b++) {
              ...
              var g = m[b].color
                ? m[b].color
                : n._colorSet[b % n._colorSet.length];
              d > c &&
                Ha(
                  k.plotArea.ctx,
                  r[b].center,
  ...
  z.prototype.cancelRequestAnimFrame =
  ...
  la.prototype.registerSpace = function (a, d) {
    "top" === a
      ? (this._topOccupied += d.height)
      : "bottom" === a
      ? (this._bottomOccupied += d.height)
      : "left" === a
      ? (this._leftOccupied += d.width)
      : "right" === a && (this._rightOccupied += d.width);
  };
  ...
  X.prototype.render = function (a) {
    ...
    for (b = 0; b < this._wrappedText.lines.length; b++)
      (g = this._wrappedText.lines[b]),
        "right" === this.horizontalAlign
          ? (c = this.width - g.width - this.padding)
          : "left" === this.horizontalAlign
          ? (c = this.padding)
          : "center" === this.horizontalAlign &&
            (c =
              (this.width - 2 * this.padding) / 2 - g.width / 2 + this.padding),
        this.ctx.fillText(g.text, c, f),
        (f += g.height);
    this.ctx.font = d;
    a && this.ctx.restore();
  };
  ...
  X.prototype.measureText = function () {
  ...
  X.prototype._getLineWithWidth = function (a, d, b) {
    ...
    b > d &&
      1 < h.length &&
      ((h = h.substr(0, h.length - 1)), (b = this.ctx.measureText(h).width));
    d = !0;
  ...
  oa.prototype.render = function () {
    if (this.text) {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? (null === this.maxWidth &&
            (this.maxWidth =
              d.width - 4 - h * ("center" === this.horizontalAlign ? 2 : 1)),
          (g = 0.5 * d.height - this.margin - 2),
          (f = 0))
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign || "right" === this.horizontalAlign
            ? (null === this.maxWidth && (this.maxWidth = d.height - 4),
              (g = 0.5 * d.width - this.margin - 2))
            : "center" === this.horizontalAlign &&
              (null === this.maxWidth && (this.maxWidth = d.width - 4),
              (g = 0.5 * d.height - 4)));
      this.wrap ||
        (g = Math.min(
          g,
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((c = d.y2 - 2 - n.height), (k = "bottom")),
          "left" === this.horizontalAlign
            ? (b = d.x1 + 2)
            : "center" === this.horizontalAlign
            ? (b = d.x1 + d.width / 2 - n.width / 2)
            : "right" === this.horizontalAlign && (b = d.x2 - 2 - n.width - h),
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((b = d.x1 + 2),
              (c = d.y2 - 2 - (this.maxWidth / 2 - n.width / 2)),
              (f = -90),
              (k = "left"),
              (this.width = n.height),
              (this.height = n.width))
            : "right" === this.horizontalAlign
            ? ((b = d.x2 - 2),
              (c = d.y1 + 2 + (this.maxWidth / 2 - n.width / 2)),
              (f = 90),
              (k = "right"),
              (this.width = n.height),
              (this.height = n.width))
            : "center" === this.horizontalAlign &&
              ((c = a.y1 + (a.height / 2 - n.height / 2)),
              (b = a.x1 + (a.width / 2 - n.width / 2)),
              (k = "center"),
              (this.width = n.width),
              (this.height = n.height)),
          (l = "center"));
  ...
  ya.prototype.render = function () {
    var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
      ...
      h = 0,
      l = (this.markerMargin =
        this.chart.options.legend && !x(this.chart.options.legend.markerMargin)
    ...
    for (var m = 0; m < this.dataSeries.length; m++) {
      ...
      if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type) {
        var e = (p.legendMarkerType = p.legendMarkerType
            ? p.legendMarkerType
            : ("line" !== p.type &&
                "stepLine" !== p.type &&
                "spline" !== p.type &&
                ...
                "bubble" !== p.type) ||
              !p.markerType
            ? ba.getDefaultLegendMarker(p.type)
            : p.markerType),
          r = p.legendText
            ? p.legendText
            ...
            : p.name,
          q = (p.legendMarkerColor = p.legendMarkerColor
            ? p.legendMarkerColor
            : p.markerColor
            ? p.markerColor
            : p._colorSet[0]),
          s =
            p.markerSize ||
            ("line" !== p.type && "stepLine" !== p.type && "spline" !== p.type)
              ? 0.75 * this.lineHeight
              : 0,
          u = p.legendMarkerBorderColor
        ...
        for (var v = 0; v < p.dataPoints.length; v++) {
          var t = p.dataPoints[v],
            ...
            q = t.legendMarkerColor
              ...
              : p.color
              ? p.color
              : p._colorSet[v % p._colorSet.length],
            s = 0.75 * this.lineHeight,
            u = t.legendMarkerBorderColor
              ? t.legendMarkerBorderColor
              : p.legendMarkerBorderColor
              ? p.legendMarkerBorderColor
              : t.markerBorderColor
              ? t.markerBorderColor
              : p.markerBorderColor,
            w = t.legendMarkerBorderThickness
              ? t.legendMarkerBorderThickness
              : p.legendMarkerBorderThickness
              ? p.legendMarkerBorderThickness
              : t.markerBorderThickness || p.markerBorderThickness
              ? Math.max(1, Math.round(0.2 * s))
              : 0,
          ...
          (t.showInLegend || (p.showInLegend && !1 !== t.showInLegend)) &&
            k.push(e);
        }
    }
    ...
    if (0 < k.length) {
      ...
      this.itemWidth = q;
      this.height =
        !1 === this.itemWrap ? n.length * this.lineHeight : this.height + v;
    ...
    for (m = d = 0; m < n.length; m++) {
      ...
      for (t = v = 0; t < p.items.length; t++) {
        ...
        this.ghostCtx.fillRect(
          ...
          e.textBlock.x + e.textBlock.width - r,
          e.textBlock.height
        );
  ...
  U(ba, M);
  ba.prototype.getDefaultAxisPlacement = function () {
    var a = this.type;
    if (
      "column" === a ||
      "line" === a ||
        ...
        if (e) {
          switch (this.type) {
            ...
            case "rangeSplineArea":
              ...
              u = b ? 20 : s;
              q = Math.min(
                Math.sqrt(Math.pow(e.x1 - a, 2) + Math.pow(e.y1 - d, 2)),
                Math.sqrt(Math.pow(e.x1 - a, 2) + Math.pow(e.y2 - d, 2))
              );
              q <= u &&
                c.push({
                  dataPoint: r,
            ...
            case "doughnut":
              s = e.center;
              u =
                "doughnut" === this.type ? e.percentInnerRadius * e.radius : 0;
              q = Math.sqrt(Math.pow(s.x - a, 2) + Math.pow(s.y - d, 2));
              q < e.radius &&
                q > u &&
                ((q = Math.atan2(d - s.y, a - s.x)),
                0 > q && (q += 2 * Math.PI),
                (q = Number(
                  ((((180 * (q / Math.PI)) % 360) + 360) % 360).toFixed(12)
                )),
                (s = Number(
                  (
                    (((180 * (e.startAngle / Math.PI)) % 360) + 360) %
                    360
                  ).toFixed(12)
                )),
                (u = Number(
                  (
                    (((180 * (e.endAngle / Math.PI)) % 360) + 360) %
                    360
                  ).toFixed(12)
                )),
                0 === u && 1 < e.endAngle && (u = 360),
                s >= u && 0 !== r.y && ((u += 360), q < s && (q += 360)),
                q > s &&
                  q < u &&
                  (c.push({
                    dataPoint: r,
            ...
            case "candlestick":
              if (
                (a >= e.x1 - e.borderThickness / 2 &&
                  a <= e.x2 + e.borderThickness / 2 &&
                  d >= e.y2 - e.borderThickness / 2 &&
                  d <= e.y3 + e.borderThickness / 2) ||
                (Math.abs(e.x2 - a + e.x1 - a) < e.borderThickness &&
                  d >= e.y1 &&
                  d <= e.y4)
              )
                c.push({
            ...
            case "ohlc":
              if (
                ...
                (a >= e.x1 &&
                  a <= (e.x2 + e.x1) / 2 &&
                  d >= e.y1 - e.borderThickness / 2 &&
                  d <= e.y1 + e.borderThickness / 2) ||
                (a >= (e.x1 + e.x2) / 2 &&
                  a <= e.x2 &&
                  d >= e.y4 - e.borderThickness / 2 &&
                  d <= e.y4 + e.borderThickness / 2)
              )
                c.push({
                  dataPoint: r,
  ...
  ba.prototype.getMarkerProperties = function (a, d, b, c) {
    ...
    return {
      ...
      borderColor: f[a].markerBorderColor
        ...
        ? this.markerBorderColor
        : null,
      borderThickness: f[a].markerBorderThickness
  ...
  A.prototype.createLabels = function () {
    ...
    if ("axisX" === this.type && b && !this.logarithmic)
      for (
        ...
        (a = b.getTime()),
          (a = this.labelFormatter
            ...
            ? this.labels[a]
            : Fa(b, this.valueFormatString, this.chart._cultureInfo)),
          (a = new X(this.ctx, {
            x: 0,
            y: 0,
            maxWidth: g,
      ...
      if (this.labels) {
        a = Math.ceil(l);
        for (
          var l = Math.ceil(this.intervalStartPosition), p = !1, b = l;
      ...
      if (
        ...
        if (
          ...
          for (b = 0; b < this._labels.length; b++) {
            ...
            for (var q, s = a.text.split(" "), c = 0; c < s.length; c++)
              (e = s[c]),
                (this.ctx.font =
                  a.fontStyle +
                  " " +
                  ...
                  "px " +
                  a.fontFamily),
                (e = this.ctx.measureText(e)),
                e.width > p && ((q = b), (p = e.width));
          }
          b = 0;
          for (
                ...
                if (x(this.options.labelWrap))
                  if (!x(this.options.labelMaxWidth))
                    ...
                    if (
                      ...
                      ((0 === q &&
                        p +
                          this._labels[q + 1].textBlock.measureText().width -
                          2 * g >
                          l) ||
    ...
    for (b = 0; b < this.stripLines.length; b++) {
      ...
      if ("outside" === g.labelPlacement) {
        ...
        if ("bottom" === this._position || "top" === this._position)
          u =
            "undefined" === typeof g.options.labelWrap
              ? this.sessionVariables.labelMaxHeight
              : g.labelWrap
              ? (0.8 * this.chart.height) >> 0
              : 1.5 * this.labelFontSize;
        if ("left" === this._position || "right" === this._position)
          u =
            "undefined" === typeof g.options.labelWrap
              ...
              : 1.5 * this.labelFontSize;
        d = x(g.options.labelBackgroundColor)
          ? "#EEEEEE"
        ...
        (h =
          ...
          (u =
            "undefined" === typeof g.options.labelWrap || g.labelWrap
              ? "bottom" === this._position || "top" === this._position
                ? (0.8 * this.chart.width) >> 0
                : (0.8 * this.chart.height) >> 0
              : 1.5 * this.labelFontSize),
  ...
  A.setLayoutAndRender = function (a, d, b, c, f, g) {
    ...
    if (a && 0 < a.length)
      for (e = 0; e < a.length; e++)
        a[e] &&
          a[e].title &&
          (a[e]._titleTextBlock = new X(a[e].ctx, {
            text: a[e].title,
            horizontalAlign: "center",
    ...
    if (d && 0 < d.length)
      for (e = 0; e < d.length; e++)
        d[e] &&
          d[e].title &&
          (d[e]._titleTextBlock = new X(d[e].ctx, {
            text: d[e].title,
            horizontalAlign: "center",
    ...
    if (b && 0 < b.length)
      for (e = 0; e < b.length; e++)
        b[e] &&
          b[e].title &&
          (b[e]._titleTextBlock = new X(b[e].ctx, {
            text: b[e].title,
            horizontalAlign: "center",
    ...
    if (c && 0 < c.length)
      for (e = 0; e < c.length; e++)
        c[e] &&
          c[e].title &&
          (c[e]._titleTextBlock = new X(c[e].ctx, {
            text: c[e].title,
            horizontalAlign: "center",
    ...
    if ("normal" === f) {
      ...
      if (a && 0 < a.length)
        for (e = 0; e < a.length; e++)
          a[e] &&
            a[e].title &&
            ((a[e]._titleTextBlock.maxWidth = a[e].titleMaxWidth || g.width),
            (a[e]._titleTextBlock.maxHeight = a[e].titleWrap
              ? 0.8 * g.height
              : 1.5 * a[e].titleFontSize),
            (a[e]._titleTextBlock.angle = 0));
      if (d && 0 < d.length)
        for (e = 0; e < d[e].length; e++)
          d[e] &&
            d[e].title &&
            ((d[e]._titleTextBlock.maxWidth = d[e].titleMaxWidth || g.width),
            (d[e]._titleTextBlock.maxHeight = d[e].titleWrap
              ? 0.8 * g.height
              : 1.5 * d[e].titleFontSize),
            (d[e]._titleTextBlock.angle = 0));
      if (b && 0 < b.length)
        for (e = 0; e < b.length; e++)
          b[e] &&
            b[e].title &&
            ((b[e]._titleTextBlock.maxWidth = b[e].titleMaxWidth || g.height),
            (b[e]._titleTextBlock.maxHeight = b[e].titleWrap
              ? 0.8 * g.width
              : 1.5 * b[e].titleFontSize),
            (b[e]._titleTextBlock.angle = -90));
      if (c && 0 < c.length)
        for (e = 0; e < c.length; e++)
          c[e] &&
            c[e].title &&
            ((c[e]._titleTextBlock.maxWidth = c[e].titleMaxWidth || g.height),
            (c[e]._titleTextBlock.maxHeight = c[e].titleWrap
              ? 0.8 * g.width
              : 1.5 * c[e].titleFontSize),
            (c[e]._titleTextBlock.angle = 90));
      for (; 4 > r; ) {
        var L = 0,
          R = 0,
          P = 0,
          ...
          U = 0;
        if (b && 0 < b.length)
          for (v = [], e = V = 0; e < b.length; e++)
            v.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateWidth() : 0)),
              (V += v[e]),
              (B += b[e] ? b[e].margin : 0);
        else v.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
        J.push(v);
        if (c && 0 < c.length)
          for (t = [], e = U = 0; e < c.length; e++)
            t.push(Math.ceil(c[e] ? c[e].createLabelsAndCalculateWidth() : 0)),
              (U += t[e]),
              (S += c[e] ? c[e].margin : 0);
        ...
        k = Math.round(
          g.x2 - U - S > m.width - 10 ? m.width - 10 : g.x2 - U - S
        );
        if (a && 0 < a.length)
          for (u = [], e = Y = 0; e < a.length; e++)
            a[e] && (a[e].lineCoordinates = {}),
              (a[e].lineCoordinates.width = Math.abs(k - h)),
              a[e].title &&
        ...
        G.push(u);
        if (d && 0 < d.length)
          for (w = [], e = W = 0; e < d.length; e++)
            d[e] && (d[e].lineCoordinates = {}),
              (d[e].lineCoordinates.width = Math.abs(k - h)),
              d[e].title &&
                (d[e]._titleTextBlock.maxWidth =
                  0 < d[e].titleMaxWidth &&
                  d[e].titleMaxWidth < d[e].lineCoordinates.width
                    ? d[e].titleMaxWidth
                    : d[e].lineCoordinates.width),
              w.push(
                Math.ceil(d[e] ? d[e].createLabelsAndCalculateHeight() : 0)
              ),
              (W += w[e]),
              (N += d[e] ? d[e].margin : 0);
        else
        ...
        if (a && 0 < a.length)
          for (e = 0; e < a.length; e++)
            a[e] &&
              ((a[e].lineCoordinates.x1 = h),
              (a[e].lineCoordinates.x2 = Math.round(
                g.x2 - U - S > m.width - 10 ? m.width - 10 : g.x2 - U - S
              )),
              a[e]._labels &&
                ...
                (q =
                  n.textBlock.width *
                    Math.cos((Math.PI / 180) * Math.abs(n.textBlock.angle)) +
                  (n.textBlock.height - l.textBlock.fontSize / 2) *
                    Math.sin((Math.PI / 180) * Math.abs(n.textBlock.angle))),
                (s =
                  l.textBlock.width *
              ...
              a[e] &&
                ...
                ((l = 0),
                0 < a[e].labelAngle
                  ? A + s > k && (l += 0 < a[e].labelAngle ? A + s - k - U : 0)
                  : 0 > a[e].labelAngle
                  ? z - q < h &&
                    z - q < a[e].viewportMinimum &&
                    (D =
                      h -
                      (B +
                        a[e].tickLength +
              ...
              (l = Math.round(g.y2 - Y - f + L)),
              (n = Math.round(g.y2)),
              (a[e].lineCoordinates.x2 = k),
              (a[e].lineCoordinates.width = k - h),
        ...
        if (d && 0 < d.length)
          for (e = 0; e < d.length; e++)
            (d[e].lineCoordinates.x1 = Math.round(g.x1 + V + B)),
              (d[e].lineCoordinates.x2 = Math.round(
                g.x2 - U - S > m.width - 10 ? m.width - 10 : g.x2 - U - S
              )),
              (d[e].lineCoordinates.width = Math.abs(k - h)),
              d[e]._labels &&
                1 < d[e]._labels.length &&
                ((n = d[e]._labels[1]),
                (l =
                  "dateTime" === d[e].chart.plotInfo.axisXValueType
                    ? d[e]._labels[d[e]._labels.length - 2]
                    : d[e]._labels[d[e]._labels.length - 1]),
                (q =
                  n.textBlock.width *
                    Math.cos((Math.PI / 180) * Math.abs(n.textBlock.angle)) +
                  (n.textBlock.height - l.textBlock.fontSize / 2) *
              ...
              (l = Math.round(g.y1)),
              (n = Math.round(g.y2 + d[e].margin)),
              (d[e].lineCoordinates.y1 = l + W + N - R),
              (d[e].lineCoordinates.y2 = l),
              (d[e].bounds = {
                x1: h,
                y1: l + (W + N - w[e] - R),
                x2: k,
          ...
          for (e = 0; e < b.length; e++)
            (B = 10),
              b[e] &&
                ...
                (B = 0 < a.length ? 0 : b[e]._labels[0].textBlock.height / 2),
                (n = Math.round(g.y2 - Y - f - B)),
                (b[e].lineCoordinates = {
                  x1: k - P,
                  y1: l,
                  x2: k - P,
            ...
            c[e] &&
              ...
              (B =
                c[e]._labels && 0 < c[e]._labels.length
                  ...
                  : 0),
              (l = Math.round(
                g.y1 + W + N < Math.max(B, 10) ? Math.max(B, 10) : g.y1 + W + N
              )),
              (B = 0 < a.length ? 0 : c[e]._labels[0].textBlock.height / 2),
              (n = Math.round(g.y2 - (Y + f + B))),
              (c[e].lineCoordinates = {
                x1: h + O,
                y1: l,
              ...
              a[e]._labels &&
                ...
                (A =
                  "dateTime" === a[e].chart.plotInfo.axisXValueType
                    ? (a[e].logarithmic
                        ? Math.log(
                            a[e]._labels[a[e]._labels.length - 2].position /
                              a[e].viewportMinimum
                          ) / a[e].conversionParameters.lnLogarithmBase
                        : a[e]._labels[a[e]._labels.length - 2].position -
                          a[e].viewportMinimum) *
                    ...
                    : (a[e].logarithmic
                        ? Math.log(
                            a[e]._labels[a[e]._labels.length - 1].position /
                              a[e].viewportMinimum
                          ) / a[e].conversionParameters.lnLogarithmBase
                        : a[e]._labels[a[e]._labels.length - 1].position -
                          a[e].viewportMinimum) *
            ...
            d[e].calculateValueToPixelConversionParameters(),
              d[e]._labels &&
                ...
                ((z =
                  (d[e].logarithmic
                    ? Math.log(
                        d[e]._labels[1].position / d[e].viewportMinimum
                      ) / d[e].conversionParameters.lnLogarithmBase
                    : d[e]._labels[1].position - d[e].viewportMinimum) *
                    Math.abs(d[e].conversionParameters.pixelPerUnit) +
                  d[e].lineCoordinates.x1),
                (A =
                  "dateTime" === d[e].chart.plotInfo.axisXValueType
                    ? (d[e].logarithmic
                        ? Math.log(
                            d[e]._labels[d[e]._labels.length - 2].position /
                              d[e].viewportMinimum
                          ) / d[e].conversionParameters.lnLogarithmBase
                        : d[e]._labels[d[e]._labels.length - 2].position -
                          d[e].viewportMinimum) *
                    ...
                    : (d[e].logarithmic
                        ? Math.log(
                            d[e]._labels[d[e]._labels.length - 1].position /
                              d[e].viewportMinimum
                          ) / d[e].conversionParameters.lnLogarithmBase
                        : d[e]._labels[d[e]._labels.length - 1].position -
                          d[e].viewportMinimum) *
        ...
        for (e = 0; e < d.length; e++)
          d[e] &&
            ...
            (d[e]._titleTextBlock.maxHeight = d[e].titleWrap
              ? 0.8 * g.height
              : 1.5 * d[e].titleFontSize),
            (d[e]._titleTextBlock.angle = 90));
      if (b && 0 < b.length)
        for (e = 0; e < b.length; e++)
          b[e] &&
            b[e].title &&
            ((b[e]._titleTextBlock.maxWidth = b[e].titleMaxWidth || g.width),
            (b[e]._titleTextBlock.maxHeight = b[e].titleWrap
              ? 0.8 * g.height
              : 1.5 * b[e].titleFontSize),
      ...
      if (c && 0 < c.length)
        for (e = 0; e < c.length; e++)
          c[e] &&
            c[e].title &&
            ((c[e]._titleTextBlock.maxWidth = c[e].titleMaxWidth || g.width),
            (c[e]._titleTextBlock.maxHeight = c[e].titleWrap
              ? 0.8 * g.height
              : 1.5 * c[e].titleFontSize),
            (c[e]._titleTextBlock.angle = 0));
      for (; 4 > r; ) {
        W = Y = V = O = S = B = N = f = P = M = R = L = 0;
        if (a && 0 < a.length)
          for (D = [], e = Y = 0; e < a.length; e++)
            D.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateWidth() : 0)),
              (Y += D[e]),
              (f += a[e] ? a[e].margin : 0);
        else D.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
        H.push(D);
        if (d && 0 < d.length)
          for (q = [], e = W = 0; e < d.length; e++)
            q.push(Math.ceil(d[e] ? d[e].createLabelsAndCalculateWidth() : 0)),
              (W += q[e]),
              (N += d[e] ? d[e].margin : 0);
        ...
        if (b && 0 < b.length)
          for (e = 0; e < b.length; e++)
            (b[e].lineCoordinates = {}),
              ...
              (k = Math.round(
                g.x2 - W - N > m.width - 10 ? m.width - 10 : g.x2 - W - N
              )),
              b[e].labelAutoFit &&
                !x(u) &&
                (0 < !a.length &&
              ...
              (b[e].lineCoordinates.x2 = k),
              (b[e].lineCoordinates.width = Math.abs(k - h)),
              b[e].title &&
                (b[e]._titleTextBlock.maxWidth =
                  0 < b[e].titleMaxWidth &&
                ...
                (0 < !a.length &&
                  (h =
                    0 < c[e].labelAngle
                      ...
                      : h),
                0 < !d.length && (k -= t / 2)),
              (c[e].lineCoordinates.x1 = h),
              (c[e].lineCoordinates.x2 = k),
              (c[e].lineCoordinates.width = Math.abs(k - h)),
              c[e].title &&
                (c[e]._titleTextBlock.maxWidth =
                  0 < c[e].titleMaxWidth &&
        ...
        if (b && 0 < b.length)
          for (z = [], e = O = 0; e < b.length; e++)
            z.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateHeight() : 0)),
              (O += z[e] + b[e].margin),
              (B += b[e].margin);
        else
        ...
        s.push(z);
        if (c && 0 < c.length)
          for (A = [], e = V = 0; e < c.length; e++)
            A.push(Math.ceil(c[e] ? c[e].createLabelsAndCalculateHeight() : 0)),
              (V += A[e]),
              (S += c[e].margin);
        else
        ...
        if (b && 0 < b.length)
          for (e = b.length - 1; 0 <= e; e--)
            (l = Math.round(g.y2)),
              ...
              (b[e].lineCoordinates.y1 = l - (z[e] + b[e].margin + L)),
              (b[e].lineCoordinates.y2 = l - (z[e] + b[e].margin + L)),
              (b[e].bounds = {
                x1: h,
        ...
        if (c && 0 < c.length)
          for (e = c.length - 1; 0 <= e; e--)
            c[e] &&
              ((l = Math.round(g.y1)),
              (n = Math.round(g.y1 + (A[e] + c[e].margin + R))),
              (c[e].lineCoordinates.y1 = n),
              (c[e].lineCoordinates.y2 = n),
              (c[e].bounds = {
                x1: h,
                y1: l + (c[e].margin + R),
                x2: k,
              ...
              b && 0 < b.length
                ? Math.round(
                    b[0]
                      ...
                      : g.y2 - O > m.height - Math.max(B, 10)
                      ? m.height - Math.max(B, 10)
                      : g.y2 - O
                  )
                : g.y2 > m.height - Math.max(B, 10)
                ? m.height - Math.max(B, 10)
                : g.y2;
            if (b && 0 < b.length)
                ...
                b[B] &&
                  ...
                  ((k =
                    0 > b[B].labelAngle
                      ...
                      : k),
                  (h =
                    0 > b[B].labelAngle || 0 === b[B].labelAngle ? k - Y : h));
            if (c && 0 < c.length)
              for (B = 0; B < c.length; B++)
                c[B] &&
                  c[B].labelAutoFit &&
        ...
        if (d && 0 < d.length)
          for (e = 0; e < d.length; e++) {
            B =
              d[e]._labels && 0 < d[e]._labels.length
                ? d[e]._labels[0].textBlock.fontSize / 2
                : 0;
            h = Math.round(g.x1 - f);
            l =
              c && 0 < c.length
            ...
            if (c && 0 < c.length)
              for (B = 0; B < c.length; B++)
                c[B] &&
                  c[B].labelAutoFit &&
                  ((k = c[B].lineCoordinates.x2), (h = k - W));
            d[e].lineCoordinates = {
              x1: k + P,
              y1: l,
              x2: k + P,
            ...
            d[e].title &&
              (d[e]._titleTextBlock.maxWidth =
                0 < d[e].titleMaxWidth &&
                d[e].titleMaxWidth < d[e].lineCoordinates.height
                  ? d[e].titleMaxWidth
                  : d[e].lineCoordinates.height);
            d[e].calculateValueToPixelConversionParameters();
            P += q[e] + d[e].margin;
          }
        if (b && 0 < b.length)
    ...
    if ("undefined" === typeof this.options.interval) {
      if ("bottom" === this._position || "top" === this._position)
        if (
          ...
          for (
            var d = [],
              c = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2,
              g,
            ...
            m.position > this.viewportMaximum ||
              !(
                k === this._labels.length - 1 ||
                g < (Math.log(h / m.position) * l) / c
              ) ||
              (d.push(m),
              (h = m.position),
              (g =
          ...
          for (k = 0; k < this._labels.length; k++)
            (m = this._labels[k]),
              m.position < this.viewportMinimum ||
                ((m =
                  m.textBlock.width *
                    Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) +
                  m.textBlock.height *
    ...
    if ("bottom" === this._position) {
      for (var m, k = 0; k < this._labels.length; k++)
        (m = this._labels[k]),
          m.position < this.viewportMinimum ||
            m.position > this.viewportMaximum ||
            ((b = this.getPixelCoordinatesOnAxis(m.position)),
            (a && 0 !== f++ % 2 && this.labelAutoFit) ||
              (this.tickThickness &&
                ...
                this.ctx.stroke()),
              0 === m.textBlock.angle
                ? ((b.x -= m.textBlock.width / 2),
                  (b.y += this.tickLength + m.textBlock.fontSize / 2))
                : ((b.x -=
                    0 > this.labelAngle
                      ? m.textBlock.width *
        ...
        (m = this._labels[k]),
          m.position < this.viewportMinimum ||
            ...
            (a && 0 !== f++ % 2 && this.labelAutoFit) ||
              ...
              0 === m.textBlock.angle
                ? ((b.x -= m.textBlock.width / 2),
                  (b.y -= this.tickLength + m.textBlock.height / 2))
                : ((b.x +=
                    (m.textBlock.height -
                      this.tickLength -
          ...
          m.position < this.viewportMinimum ||
            ...
            (a && 0 !== f++ % 2 && this.labelAutoFit) ||
              (this.tickThickness &&
                ...
                (this.ctx.strokeStyle = this.tickColor),
                (c =
                  1 === this.ctx.lineWidth % 2 ? (b.y << 0) + 0.5 : b.y << 0),
                this.ctx.beginPath(),
                  ...
                  (m.textBlock.x =
                    0 < this.labelAngle
                      ...
                      : b.x -
                        m.textBlock.width *
                          Math.cos((Math.PI / 180) * this.labelAngle) +
                        (m.textBlock.height - m.textBlock.fontSize / 2 - 5) *
                          Math.sin((Math.PI / 180) * this.labelAngle) -
                        this.tickLength)),
              m.textBlock.render(!0)));
      this.title &&
        ...
        (m = this._labels[k]),
          m.position < this.viewportMinimum ||
            ...
            (a && 0 !== f++ % 2 && this.labelAutoFit) ||
              ...
              0 === this.labelAngle
                ? ((m.textBlock.y = b.y),
                  (m.textBlock.x = b.x + this.tickLength + 5))
                : ((m.textBlock.y =
                    0 > this.labelAngle
                      ? b.y
                      : b.y -
  ...
  A.prototype.renderInterlacedColors = function () {
    ...
    if (
      ...
      for (
        ...
        d
          ? ((d = this.getPixelCoordinatesOnAxis(this._labels[f].position)),
            (b =
              f + 1 > this._labels.length - 1
                ? this.getPixelCoordinatesOnAxis(this.viewportMaximum)
                : this.getPixelCoordinatesOnAxis(this._labels[f + 1].position)),
            a.fillRect(
              Math.min(b.x, d.x),
              c.y1,
              Math.abs(b.x - d.x),
      ...
      for (
        ...
        d
          ? ((b = this.getPixelCoordinatesOnAxis(this._labels[f].position)),
            (d =
              f + 1 > this._labels.length - 1
                ? this.getPixelCoordinatesOnAxis(this.viewportMaximum)
                : this.getPixelCoordinatesOnAxis(this._labels[f + 1].position)),
            ...
            if (
              (n &&
                ...
                "pixel" === n._thicknessType &&
                  (this.ctx.lineWidth = n.thickness)),
              ...
              "top" === this._position
                ...
                : "left" === this._position
                ? ((m =
                    1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0),
                  this.ctx.beginPath(),
  ...
  A.prototype.renderAxisLine = function () {
    ...
    if ("bottom" === this._position || "top" === this._position) {
      if (this.lineThickness) {
        ...
        a.setLineDash &&
          a.setLineDash(F(this.lineDashType, this.lineThickness));
        var d =
      ...
      ("left" !== this._position && "right" !== this._position) ||
        ...
        a.beginPath(),
        a.moveTo(d, this.lineCoordinates.y1),
        a.lineTo(d, this.lineCoordinates.y2),
        a.stroke());
    a.restore();
  };
    ...
    var d = 0,
      ...
      d =
        "number" === typeof a
          ...
          ? a.y
          : a.x;
    return (d = this.logarithmic
      ? Math.pow(
          this.logarithmBase,
          (d - this.conversionParameters.reference) /
  ...
  A.prototype.calculateValueToPixelConversionParameters = function (a) {
    ...
    if ("bottom" === this._position || "top" === this._position)
      this.logarithmic
        ? ((a.lnLogarithmBase = Math.log(this.logarithmBase)),
          (a.pixelPerUnit =
            ((this.reversed ? -1 : 1) * d * a.lnLogarithmBase) /
            Math.log(Math.abs(this.range))))
        : (a.pixelPerUnit =
            ((this.reversed ? -1 : 1) * d) / Math.abs(this.range)),
        (a.reference = this.reversed
    ...
    if ("left" === this._position || "right" === this._position)
      this.logarithmic
        ? ((a.lnLogarithmBase = Math.log(this.logarithmBase)),
          (a.pixelPerUnit =
            ((this.reversed ? 1 : -1) * b * a.lnLogarithmBase) /
            Math.log(Math.abs(this.range))))
        : (a.pixelPerUnit =
            ((this.reversed ? 1 : -1) * b) / Math.abs(this.range)),
        (a.reference = this.reversed
          ? this.lineCoordinates.y1
  ...
  A.prototype.calculateAxisParameters = function () {
    if (this.logarithmic) this.calculateLogarithamicAxisParameters();
        ...
        "axisY" === this.type &&
          ...
          0 === f && 0 === g
            ...
            ? ((c = Math.min(Math.abs(0.01 * Math.abs(g)), 5)),
              ...
              (f -= c))
            : f > g
            ? ((c = Math.min(Math.abs(0.01 * Math.abs(g - f)), 5)),
              0 <= g ? (f = g - c) : (g = f + c))
            : ((c = Math.min(Math.abs(0.01 * Math.abs(g - f)), 0.05)),
              0 !== g && (g += c),
              0 !== f && (f -= c)),
          (h =
            Infinity !== this.dataInfo.minDiff
      ...
      if (
        !this.valueFormatString &&
        ((this.valueFormatString = "#,##0.##"), 1 > this.range)
      ) {
  ...
  A.prototype.calculateLogarithamicAxisParameters = function () {
    ...
    "axisX" === this.type
      ? ((c =
        ...
        (g =
          Infinity !== this.dataInfo.minDiff
            ? this.dataInfo.minDiff
            : f / c > this.logarithmBase
            ? (f / c) * Math.pow(this.logarithmBase, 0.5)
            : this.logarithmBase))
      : "axisY" === this.type &&
        ((c =
          null !== this.viewportMinimum
        ...
        0 >= c && !isFinite(f)
          ...
          : isFinite(f) || (f = c),
        1 === c && 1 === f
          ? ((f *= this.logarithmBase - 1 / this.logarithmBase), (c = 1))
          : 1 === f / c
          ? ((h = Math.min(
          ...
          : c > f
          ? ((h = Math.min(
              (c / f) * Math.pow(this.logarithmBase, 0.01),
              Math.pow(this.logarithmBase, 5)
            )),
            1 <= f ? (c = f / h) : (f = c * h))
          : ((h = Math.min(
              (f / c) * Math.pow(this.logarithmBase, 0.01),
    ...
    this.options && 0 < this.options.interval
      ...
      : ((this.interval = A.getNiceExponent(Math.log(h) / d / (a - 1), !0)),
        (b = A.getNiceNumber(linearRange / (a - 1), !0)));
    if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
      this.viewportMinimum =
        "axisX" === this.type
          ? c / Math.sqrt(g)
    ...
    if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
      this.viewportMaximum =
        "axisX" === this.type
          ...
          : Math.pow(
              this.logarithmBase,
              this.interval * Math.ceil(Math.log(f) / d / this.interval)
            );
    ...
    if (null === this.minimum || null === this.maximum)
      "axisX" === this.type
        ...
        : "axisY" === this.type &&
          ((c = null !== this.minimum ? this.minimum : this.dataInfo.min),
          (f = null !== this.maximum ? this.maximum : this.dataInfo.max),
          isFinite(c) || isFinite(f)
            ? 1 === c && 1 === f
              ? ((f *= this.logarithmBase), (c /= this.logarithmBase))
              : 1 === f / c
              ? ((h = Math.pow(this.logarithmBase, this.interval)),
                (f *= h),
                (c /= h))
              : c > f
              ? ((h = Math.min(0.01 * (c / f), 5)),
                1 <= f ? (c = f / h) : (f = c * h))
              : ((h = Math.min(
                  (f / c) * Math.pow(this.logarithmBase, 0.01),
                  Math.pow(this.logarithmBase, 0.04)
  ...
  pa.prototype.render = function () {
    ...
    if (0 < d) {
      ...
      this.ctx.setLineDash && this.ctx.setLineDash(F(this.lineDashType, d));
      if ("bottom" === this.parent._position || "top" === this.parent._position)
        (f = g = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
  ...
  V.prototype.mouseMoveHandler = function (a, d) {
    (this._lastUpdated && 40 > new Date().getTime() - this._lastUpdated) ||
      ((this._lastUpdated = new Date().getTime()), this._updateToolTip(a, d));
  };
    ...
    if (!this.chart.disableToolTip) {
      ...
      if (
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          if (this.chart.axisX)
            for (var l = 0; l < this.chart.axisX.length; l++) {
              for (
                var h = this.chart.axisX[l].convertPixelToValue({
                    y: d,
                  }),
                  k = null,
                  c = 0;
                ...
                (k = this.chart.axisX[l].dataSeries[c].getDataPointAtX(h, b)) &&
                  0 <= k.index &&
                  ((k.dataSeries = this.chart.axisX[l].dataSeries[c]),
                  null !== k.dataPoint.y && f.push(k));
              k = null;
            }
          if (this.chart.axisX2)
            for (l = 0; l < this.chart.axisX2.length; l++) {
              ...
              for (c = 0; c < this.chart.axisX2[l].dataSeries.length; c++)
                (k = this.chart.axisX2[l].dataSeries[c].getDataPointAtX(
                  h,
                  b
                )) &&
                  0 <= k.index &&
                  ((k.dataSeries = this.chart.axisX2[l].dataSeries[c]),
                  null !== k.dataPoint.y && f.push(k));
              k = null;
            }
        } else {
          ...
          if (this.chart.axisX)
            for (l = 0; l < this.chart.axisX.length; l++)
              for (
                h = this.chart.axisX[l].convertPixelToValue({
                  x: a,
                }),
                  k = null,
                  c = 0;
        ...
        for (c = 0; c < f.length; c++)
          f[c].dataPoint.x.valueOf() === b.dataPoint.x.valueOf() &&
            g.push(f[c]);
        f = null;
      } else {
        if ((k = this.chart.getDataPointAtXY(a, d, b)))
          ...
          if (
            ((k = Ma(a, d, this.chart._eventManager.ghostCtx)),
            0 < k &&
        ...
        if (0 <= this.currentSeriesIndex) {
          ...
          if (0 <= this.currentDataPointIndex)
            (c = f.dataPoints[this.currentDataPointIndex]),
              (k.dataSeries = f),
              (k.dataPoint = c),
      ...
      if (
        ...
        !1 === g.highlightEnabled ||
          ...
          "rangeSplineArea" === c.type
            ...
            : "candlestick" === c.type
            ? ((d.globalAlpha = 1),
              (d.strokeStyle = f.color),
              (d.lineWidth = 2 * f.borderThickness),
              (c = 0 === d.lineWidth % 2 ? 0 : 0.5),
              d.beginPath(),
              d.moveTo(f.x3 - c, Math.min(f.y2, f.y3)),
              d.lineTo(f.x3 - c, Math.min(f.y1, f.y4)),
              d.stroke(),
              d.beginPath(),
              d.moveTo(f.x3 - c, Math.max(f.y1, f.y4)),
              d.lineTo(f.x3 - c, Math.max(f.y2, f.y3)),
              d.stroke(),
              R(
                d,
                f.x1,
            ...
            : "ohlc" === c.type &&
              ...
              (c = 0 === d.lineWidth % 2 ? 0 : 0.5),
              d.beginPath(),
              d.moveTo(f.x3 - c, f.y2),
              d.lineTo(f.x3 - c, f.y3),
              d.stroke(),
              d.beginPath(),
              d.moveTo(f.x3, f.y1),
              d.lineTo(f.x1, f.y1),
        ...
        if (
          ...
          0 === l &&
            ...
            (this.chart.axisX && 0 < this.chart.axisX.length
              ? (n +=
                  "undefined" !== typeof this.chart.axisX[0].labels[f.x]
                    ? this.chart.axisX[0].labels[f.x]
                    : "{x}")
              : this.chart.axisX2 &&
                0 < this.chart.axisX2.length &&
                (n +=
                  "undefined" !== typeof this.chart.axisX2[0].labels[f.x]
                    ? this.chart.axisX2[0].labels[f.x]
                    : "{x}"),
            (n += "</br>"),
            (n = this.chart.replaceKeywordsWithValue(n, f, c, g))),
          null !== f.toolTipContent &&
            ("undefined" !== typeof f.toolTipContent ||
          ...
          null === b && (b = "");
          !0 === this.reversed
            ? ((b = this.chart.replaceKeywordsWithValue(a, f, c, g) + b),
              l < d.length - 1 && (b = "</br>" + b))
    ...
    if ("mousemove" === a.type || "click" === a.type) {
      ...
      if (
        ...
        if (((c = this.objectMap[c]), "dataPoint" === c.objectType)) {
          ...
          "legendItem" === c.objectType &&
            ((f = this.chart.data[c.dataSeriesIndex]),
            (g =
              null !== c.dataPointIndex
                ? f.dataPoints[c.dataPointIndex]
                : null),
            (c.eventParameter = {
              x: b.x,
              y: b.y,
      ...
      for (b = 0; b < this.mouseoveredObjectMaps.length; b++) {
        ...
        g
          ...
          : f.push(this.mouseoveredObjectMaps[b]);
      }
  ...
  Ea.prototype.animate = function (a, d, b, c, f) {
    ...
    for (a = []; 0 < this.animations.length; )
      if (
        ...
        (c = 0),
        d.startTime <= b &&
          ((c = f(Math.min(b - d.startTime, d.duration), 0, 1, d.duration)),
          (c = Math.min(c, 1)),
          isNaN(c) || !isFinite(c)) &&
          (c = 1),
        1 > c && a.push(d),
      ...
      drawMarker: function (a, d, b, c, f, g, h, l) {
        if (b) {
          ...
          "circle" === c
            ...
            : "triangle" === c
            ? (b.beginPath(),
              b.moveTo(a - f / 2, d + f / 2),
              b.lineTo(a + f / 2, d + f / 2),
              b.lineTo(a, d - f / 2),
              b.closePath(),
              g && b.fill(),
              l &&
