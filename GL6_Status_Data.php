...
<head>
    ...
    <title>Machine Status Data</title>
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <br>
                                    <h5 class="m-0 font-weight-bold text-primary">Machine Status Data</h5><br>
                                </div>
                                            ...
                                            <div class="row justify-content-center ">
                                                ...
                                                <div class="col-sm-12 col-md-4 col-lg-2 mt-2 mt-md-0">
                                                    <select class="form-control" id="cell" name="cell" onchange="updateButtonName()" required>
                                                        ...
                                                        <option value="status_gl6">GL6</option>
                                                    </select>
                                                </div>
                            ...
                            <!-- === Table dan Chart === -->
                            <?php include 'Graphics/gl6-status-graphic.php' ?>
                            <div class="table-responsive">
                                <?php include 'Includes/gl6-status-filtertable.php' ?>
                            </div>
                        </div>
