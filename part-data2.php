...
<body id=" page-top">
    ...
    <div id="wrapper" class="">
        ...
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <!-- <li class="nav-item">
                <a class="nav-link" href="infotv.php">
                    <i class="fa-solid fa-tv"></i>
                    <span>Machine Info TV</span>
                </a>
            </li> -->
                ...
                <div class="container-fluid position-sticky" id="container-wrapper">
                    <!-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Machine Part Data</li>
                        </ol>
                    </div> -->
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li class="ml-3"><a data-toggle="tab" href="#menu1">Menu 1</a></li>
                                <br>
                            </ul>
                            ...
                            <!-- <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Instruction</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <!-- Bisa menutupi warning tapi harus klik tab sebelah lalu balik lagi
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
